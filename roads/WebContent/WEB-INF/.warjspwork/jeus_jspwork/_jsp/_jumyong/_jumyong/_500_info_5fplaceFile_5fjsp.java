...
public class _500_info_5fplaceFile_5fjsp extends jeus.servlet.jsp.HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse  response)
    ...
    try {
      ...
      // jsp code [from=(286,35);to=(286,37)]
      ...
      // jsp code [from=(287,39);to=(287,43)]
      ...
      // jsp code [from=(288,37);to=(288,40)]
      ...
      // jsp code [from=(289,53);to=(289,64)]
      out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${currentPage}",java.lang.String.class , pageContext.getVariableResolver(), null));

      out.write(_jspx_template16);
      // jsp code [from=(290,45);to=(290,53)]
      ...
      // jsp code [from=(298,75);to=(298,82)]
      ...
      // jsp code [from=(315,10);to=(315,24)]
      ...
      // jsp code [from=(378,27);to=(378,44)]
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != Tag.SKIP_BODY) {
          do {
            ...
            // jsp code [from=(351,58);to=(351,67)]
            ...
            // jsp code [from=(352,46);to=(352,66)]
            ...
            // jsp code [from=(353,46);to=(353,64)]
            ...
            // jsp code [from=(355,153);to=(355,170)]
            ...
            // jsp code [from=(355,176);to=(355,199)]
            ...
            // jsp code [from=(356,28);to=(356,45)]
            out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${board.ATTACH_FILE}",java.lang.String.class , pageContext.getVariableResolver(), null));

            out.write(_jspx_template30);
            // jsp code [from=(359,46);to=(359,73)]
    ...
    try {
      ...
      if (_jspx_eval_c_if_2 != Tag.SKIP_BODY) {
        do {
          ...
          // jsp code [from=(362,174);to=(362,176)]
          out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${no}",java.lang.String.class , pageContext.getVariableResolver(), null));

          out.write(_jspx_template33);
          // jsp code [from=(362,184);to=(362,193)]
          ...
          // jsp code [from=(362,209);to=(362,220)]
          out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${currentPage}",java.lang.String.class , pageContext.getVariableResolver(), null));

          out.write(_jspx_template35);
          // jsp code [from=(362,237);to=(362,249)]
          ...
          // jsp code [from=(363,83);to=(363,92)]
          out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${board.SEQ}",java.lang.String.class , pageContext.getVariableResolver(), null));

          out.write(_jspx_template37);
          // jsp code [from=(363,98);to=(363,121)]
          out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${board.ATTACH_SAVED_FILE}",java.lang.String.class , pageContext.getVariableResolver(), null));
  ...
  private final static String _jspx_template32 = "\r\n                      \t\t<img src=\"/img/mod_icon2.gif\" alt=\"수정\" width=\"34\" height=\"18\" border=\"0\" onClick=\"javascript:location.href='/jumyong/placeFileEdit.do?mode=edit&no=";
  private final static String _jspx_template33 = "&seq=";
  ...
  private final static String _jspx_template38 = "');\" alt=\"삭제\" width=\"34\" height=\"18\" border=\"0\"  style=\"cursor:pointer\" >\r\n                      \t\t";
