...
public class _500_jumji_5fview_5fjsp extends jeus.servlet.jsp.HttpJspBase {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse  response)
    ...
    try {
      ...
      // jsp code [from=(100,59);to=(100,66)]
      ...
      // jsp code [from=(109,64);to=(109,72)]
      ...
      // jsp code [from=(111,64);to=(111,78)]
      ...
      // jsp code [from=(115,52);to=(115,67)]
      ...
      // jsp code [from=(117,52);to=(117,68)]
      ...
      // jsp code [from=(121,52);to=(121,66)]
      ...
      // jsp code [from=(123,52);to=(123,63)]
      ...
      // jsp code [from=(129,14);to=(129,27)]
      ...
      // jsp code [from=(130,14);to=(130,25)]
      ...
      // jsp code [from=(131,15);to=(131,26)]
      ...
      // jsp code [from=(132,14);to=(132,24)]
      ...
      // jsp code [from=(133,14);to=(133,26)]
      ...
      // jsp code [from=(133,29);to=(133,40)]
      ...
      // jsp code [from=(133,55);to=(133,65)]
      ...
      // jsp code [from=(133,68);to=(133,77)]
      ...
      // jsp code [from=(140,10);to=(140,25)]
      ...
      // jsp code [from=(140,34);to=(140,48)]
      ...
      // jsp code [from=(148,10);to=(148,27)]
      ...
      // jsp code [from=(151,17);to=(151,31)]
      ...
      // jsp code [from=(173,191);to=(173,201)]
      out.write((String)jeus.servlet.jsp.el.JeusExpressionEvaluator.evaluate("${board.TYPE}",java.lang.String.class , pageContext.getVariableResolver(), null));

      out.write(_jspx_template35);
      // jsp code [from=(173,216);to=(173,232)]
      ...
      // jsp code [from=(201,14);to=(201,29)]
      ...
      // jsp code [from=(209,14);to=(209,32)]
      ...
      // jsp code [from=(224,14);to=(224,34)]
      ...
      // jsp code [from=(230,14);to=(230,36)]
      ...
      // jsp code [from=(237,92);to=(237,107)]
      ...
      // jsp code [from=(249,64);to=(249,83)]
      ...
      // jsp code [from=(253,64);to=(253,78)]
    ...
    try {
      ...
      if (_jspx_eval_c_if_0 != Tag.SKIP_BODY) {
        do {
          ...
          // jsp code [from=(140,90);to=(140,103)]
    ...
    try {
      ...
      if (_jspx_eval_c_when_0 != Tag.SKIP_BODY) {
        do {
          ...
          // jsp code [from=(185,12);to=(185,30)]
          ...
          // jsp code [from=(185,36);to=(185,52)]
    ...
    try {
      ...
      if (_jspx_eval_c_otherwise_0 != Tag.SKIP_BODY) {
        do {
          ...
          // jsp code [from=(191,26);to=(191,45)]
          ...
          // jsp code [from=(191,62);to=(191,80)]
