		...
		<table height="100%" width="100%" border="0" cellspacing="0" cellpadding="0" valign="top">
	      	<tr><td width="100%" height="100%" bgcolor="f9f9f9" class="M_leftborder">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sub_table">
						...
						<tr><td width="10"></td><td><input type="checkbox" onclick="layer(this.id)" name = "bg" id = "40" value="COW001">시도</td></tr>                                                                              
						<tr><td width="10"></td><td><input type="checkbox" onclick="layer(this.id)" name = "bg" id = "41" value="COW002">구도</td></tr>                                                                        
						<tr><td width="10"></td><td><input type="checkbox" onclick="layer(this.id)" name = "bg" id = "42" value="COW300">고속화도로</td></tr>
...
<script> 
	...
	//winMap.reFlush(); 
	//alert("2");
	winMap.setOffLayer('COW001','COW002','COW300','도곽경계_10000', '도곽경계_5000', '도곽경계_1000', '도곽경계_500','행정경계_시','행정경계_구','행정경계_행정동','행정경계_법정동','가스관로','가스심도','공동구','난방맨홀','난방심도','난방열관로','배전_심도','배전_지중맨홀','배전_지중관로','송전_지중맨홀','송전_지중전력구','송전_지중관로','송전_지중심도','지하상가단면상세도','지하상가_연결계단','지하상가_외곽선','지하상가_출입구','지하상가_환기구','지하철_출입구','지하철_승강장','지하철_환기구','통신맨홀','통신심도','통신관로','지하철_지상구간','지하철_지하구간','플랫폼의지붕','플랫폼');
	winMap.reFlush(); 
