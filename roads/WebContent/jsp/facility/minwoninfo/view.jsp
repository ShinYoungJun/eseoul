...
//<![CDATA[
	...
	//	var	seq		= document.getElementById("TAX_NO").value;
		...
		tabs.src	= "/facility/minwoninfo/minwon_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;// + "&SEQ=" + seq;
	}
	...
	function Tab_Jumin(adminno)
	{
		...
		var tabs 	= document.getElementById("tabUp");
		tabs.src	= "/facility/minwoninfo/jumin_view.do?ADMIN_NO=" + adminno;
	}
	...
	function Tab_Jumji(adminno)
	{
		...
		var tabs	= document.getElementById("tabUp");
		tabs.src	= "/facility/minwoninfo/sisul_view.do?ADMIN_NO=" + adminno;
	}
  ...
  <tr>
	...
	<!--상단 기안문상신,도움말 메뉴-->
      ...
      <tr>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tabUp" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/facility/minwoninfo/minwon_view.do?ADMIN_NO=${ADMIN_NO}"></iframe>
		</td>
