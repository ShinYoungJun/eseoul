                ...
                <tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
								<tr>
									...
									<td bgcolor="eaeaea" class="table_bl_left">
										...
										<input name="TO_JIBUN_MAIN" type="text" value = "${board.TO_LNBR1}"class="input_form1"  style="width:50px"   maxlength="4"  onKeyUp="count_check(this, TO_JIBUN_SUB, 4);">&nbsp; - &nbsp; <input name="TO_JIBUN_SUB" type="text"  value = "${board.TO_LNBR2}"class="input_form1"  style="width:50px"  maxlength="4"  onKeyUp="count_check(this, OFFICE, 4);">&nbsp;번지
									</td>  
								</tr>
							</table>
						</td>
					...
					<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							...
							&nbsp;&nbsp;(&nbsp;내선&nbsp;<input name="TEL_EXT" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this);" onKeyUp="nr_num_int(this);" maxlength="4" value="${board.TOTEL_EXT }">&nbsp;)
						</td>
					</tr>
