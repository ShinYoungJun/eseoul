...
//<![CDATA[
	...
	function Tab_Jumin(corpCd,guCode)
	{
		var tab	= document.getElementById("CURRENT_TABUP");
		if(tab.value	== "jumin")
			return;
		...
		tabs.src	= "/facility/gigan/jumin_view.do?CORP_CD=" + corpCd+"&GU_CODE="+guCode;
	}

	function Tab_Jumji(corpCd,guCode,requestNo,type,objectNo)
	{
		var tab	= document.getElementById("CURRENT_TABUP");
		if(tab.value	== "jumji")
			return;
		...
		var tabs	= document.getElementById("tabUp");
		tabs.src	= "/facility/gigan/jumji_view.do?CORP_CD=" + corpCd+"&GU_CODE="+guCode
					+"&REQUEST_NO="+requestNo+"&TYPE="+type+"&OBJECT_NO="+objectNo;
	}
	...
	{		
		...
		tabs.src	= "/facility/gigan/gigan_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;
	}
	...
	function Tab_Sunap(adminno)
	{
		...
		var tabs	= document.getElementById("tabDown");
		tabs.src	= "/facility/gigan/sunap_view.do?ADMIN_NO=" + adminno;
	}
	...
	function	BugwaView(seq)	//	산출조건 클릭시 부과정보 데이터 변경 (Sanchul_view.jsp 호출)
	{
		...
		var tabs	= document.getElementById("tabDown");
		tabs.src	= "/facility/gigan/bugwa_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;
	}
	...
	function	SaeweSuipBugwa()
	{
		...
		sendRequest("/facility/gigan/saewesuipbugwa.do", param, "GET", Result_SaeweSuipBugwa);
	}
	...
	<!--상단 기안문상신,도움말 메뉴-->		
      ...
      <tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111"><a href="javascript:Tab_Jumin('${CORP_CD}','${GU_CODE}')"><img name="jumin_img" src="/img/sub_petition_title2_on.gif" alt="점용인 정보" width="110" height="22" border="0"></a></td>
                  <td><a href="javascript:Tab_Jumji('${CORP_CD}','${GU_CODE}','${REQUEST_NO}','${TYPE}','${OBJECT_NO}')"><img name="jumji_img" src="/img/sub_petition_title3_off.gif" alt="점용지 정보" width="110" height="22" border="0"></a></td>
                </tr>
            </table>
            </td>
		</tr>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tabUp" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/facility/gigan/jumin_view.do?CORP_CD=${CORP_CD}&GU_CODE=${GU_CODE}"></iframe>
		</td>
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="22" background="/img/tab_line_blue.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111"><a href="javascript:Tab_Gigan('${CORP_CD}')"><img name="bugwa_img" src="/img/sub_periodi_title5_on.gif" alt="기간 연장" width="110" height="22" border="0"></a></td>
          ...
          <tr>
  			<TD>
  				<iframe width="100%" height="150" name="tabDown" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/facility/gigan/gigan_view.do?CORP_CD=${CORP_CD}&GU_CODE=${GU_CODE}&REQUEST_NO=${REQUEST_NO}&TYPE=${TYPE}&OBJECT_NO=${OBJECT_NO}"></iframe>
  			</TD>
          </tr>
