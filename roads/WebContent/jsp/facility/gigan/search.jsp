...
//<![CDATA[
	...
	function	View(corpCd,guCode,requestNo,type,objectNo)
	{
		var form = document.form;

		form.action = "/facility/gigan/view.do?CORP_CD=" + corpCd+"&GU_CODE="+guCode
...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="43"><img src="/img/sub3_cont4_title.gif" width="800" height="43"></td>
  </tr>
  <tr>
                ...
                <tr>
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
					...
					<tr>
					  ...
					  <td colspan="5" bgcolor="" class=""><table width="100%" border="0" cellpadding="0" cellspacing="0" class="">
					...
					<tr>
	                  ...
	                  <td colspan="5" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
	                    <tr>
	                      <td><input name="NAME" type="text" class="input_form1" style="width:125px" value="${NAME}"></td>
	                    </tr>
	                  </table></td>
                ...
                <tr>
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                      <tr>
                        ...
                        <td width="50" align="center" bgcolor="e5eff8" class="sub_table_b">점용인</td>
                        <td width="50" align="center" bgcolor="e5eff8" class="sub_table_b">점용지</td>
					...
					<c:choose>
						<c:when test="${blist!= null && !empty blist}">
	                      <c:forEach items="${blist}" var="board" varStatus="idx">
		                     <tr onClick="javascript:View('${board.CORP_CD}','${board.GU_CODE}','${board.REQUEST_NO}','${board.TYPE}','${board.OBJECT_NO}')" onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''" style="CURSOR: Hand;" >
