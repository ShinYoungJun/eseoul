...
<table width="800" border="0" cellpadding="0" cellspacing="0">
					...
					<td>
						<table width="760" border="2" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" width="760" border="2" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
  							...
  							<tr>
    							...
    							<td width="330" align="center" bgcolor="eaeaea" class="table_bl_left"><a href="facility_download.action?saveFileName=${dto.saveFileName}&originalFileName=${dto.originalFileName}">${dto.originalFileName}</a></td>
  							</tr>
  							<tr>
					...
					<td>
						<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
  							...
  							<tr>
    							...
    							<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">첨부파일</td>
		    					<td width="330" align="center" ><a href="javascript:location.href('facility_download.action?saveFileName=${dto.saveFileName}&originalFileName=${dto.originalFileName}')"  class="sub_table">${dto.originalFileName}</a></td>
  							</tr>
  							<tr>
    							<td width="100" height="28" align="center" bgcolor="e5eff8" class="sub_table_b">등록일</td>
	...
	<tr>
		<td>
			<img src="/img/del_icon5.gif" id="delete" name="delete" alt="삭제" width="66" height="22" border="0" onclick="location.href='facility_delete.action?sid=${dto.sid}&saveFileName=${dto.saveFileName}'" style="cursor:Pointer;" align="left">
			<img src="/img/list_icon.gif" alt="리스트" width="66" height="22" border="0" onclick="location.href='facility_list.action'" style="cursor:Pointer;" align="right">
			<img src="/img/mod_icon5.gif" id="modify" name="modify" alt="수정" width="66" height="22" border="0" onclick="location.href='facility_update.action?sid=${dto.sid}'" style="cursor:Pointer;" align="right">
		</td>
   	</tr>
</table>
</body>
