...
<form action="facility_upload.action" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="name" value="${namedata.name }">
	...
	<tr>
		<td align="right">
		<input type="submit" value=" 저장 " onclick="location.href='facility_upload.action'">
		<input type="button" value=" 취소 " onclick="location.href='facility_list.action'">
		</td>
	</tr>
</form>
</table>
