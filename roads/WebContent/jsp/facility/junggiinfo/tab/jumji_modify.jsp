...
//<![CDATA[
	...
	function choose_place(admin_no, object_no)
	{
		...
		location.href="/facility/junggiinfo/jumji_modify.do?GU_CODE="+gu_code+"&CORP_CD="+corp_cd
						...
						<tr>
							...
							<td bgcolor="eaeaea" class="table_bl_left">
								<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									<tr>
										<td>
											<input name="DEPTH_CK" type="text" class="input_form1" style="width:50px" onKeyUp="Select_Depth(); nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="3"  value="${depth_ck}">&nbsp;
							...
							<td colspan="3" bgcolor="eaeaea" class="table_bl_left">
								<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									<tr>
										...
										<td bgcolor="eaeaea" class="table_bl_left">
											<input name="SISUL_ADDR1" type="text" class="essential" style="width:250px" onFocus="Jumin_toaddr_Check();" readonly  value="${sisul_addr1}">
											<input name="SISUL_ADDR2" type="text" class="essential" style="width:250px"  value="${sisul_addr2}">
										</td>  
									</tr>
								</table>
							</td>
