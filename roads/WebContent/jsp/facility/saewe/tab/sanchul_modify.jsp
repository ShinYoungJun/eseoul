...
//<![CDATA[
	...
	function	ModifyPrc()
	{
		...
		form.action = "/jumyong/minwon/minwon_modify_prc.do";
		form.submit();
	}
	...
	function	Cancel()
	{
		...
		form.action = "/jumyong/minwon/minwon_view.do";
		form.submit();
	}
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						...
						<td><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, REQ_DATE, 'yyyymmdd')"></a></td>
						</tr>
					</table></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						...
						<td><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, PREDATE, 'yyyymmdd')"></a></td>
					  </tr>
					</table></td>
				  </tr>
				  <tr>
