...
//<![CDATA[
	...
	{	
		...
		form.action = "/facility/saewe/bugwa_register_prc.do";
		form.submit();
	}
...
///////////////////////////////////////////////////////////////////
	...
	function 	Init()
	{
		...
		if(sigu_se == "10"){
			...
			//document.getElementById("SISE").value = bonse;
		}
		
		else if(sigu_se == "50") {
		
			document.form.GUSE.value = bonse;
			//document.getElementById("GUSE").value = bonse;
	}
	  ...
	  <tr>
			  ...
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				...
				<tr>
					...
					<td width="36%" bgcolor="eaeaea" class="table_bl_left">
						<select name="TAX_GUBUN" id="TAX_SET" class="essential" style="width:70px">
							${taxation_part}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="SIGU_CD" id="SIGU_CD" type="text" class="readonly" style="width:45px" value="${ORG_CD}" readonly></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="DEPT_CD" id="DEPT_CD" type="text" class="readonly" style="width:45px" value="${DEPT_CD}" readonly></td>
				...
				<tr>
					...
					<td width="181" bgcolor="eaeaea" class="table_bl_left"><input name="BONSE" type="text" class="readonly" style="width:120px" value="${SUM}" readonly></td>
				...
				<tr>
					...
					<td width="181" bgcolor="eaeaea" class="table_bl_left"><input name="INTAX" type="text" class="readonly" style="width:120px" value="${SUM}" readonly></td>
				...
				<tr>
					...
					<td width="181" bgcolor="eaeaea" class="table_bl_left"><input name="LIMIT_SUM" type="text" class="input_form1" style="width:120px" value="${board.LIMIT_SUM}" maxlength="3"></td>
					<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">상한횟수</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="LIMIT_CNT" type="text" class="input_form1" style="width:120px" value="${board.LIMIT_CNT}" maxlength="3"></td>
				</tr>
				
				<tr>
					<td width="100" height="28" align="center" bgcolor="e5eff8" class="sub_table_b">특별이율</td>
					<td width="181" bgcolor="eaeaea" class="table_bl_left"><input name="RATE" type="text" class="input_form1" style="width:120px" value="${board.RATE}" maxlength="8"></td>
		...
		<tr>
			...
			<tr>
				...
				<td height="26" align="center"><input name="bugwa_bonse" type="text" value="${SUM}" style="width:92%; text-align:right;" class="readonly" readonly></td>
				<input name="SISE"  id ="SISE"  type="hidden" value="0" class="input_form1" style="width:90%; text-align:right;" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);  comma_paste(this);" onKeyPress="nr_num_int(this);" maxlength=13>
				<input name="GUSE"  id="GUSE" type="hidden" value="0" class="input_form1" style="width:90%; text-align:right;" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);  comma_paste(this);" onKeyPress="nr_num_int(this);" maxlength=13>
				<td align="center"><input name="bugwa_vat" type="text" value="${VAT}" class="readonly" style="width:92%; text-align:right;" readonly></td>
				<td align="center"><input name="bugwa_intax" type="text" value="${SUM}" class="readonly" style="width:92%; text-align:right;" readonly></td>
				<td align="center"><input name="bugwa_overtax" type="text" value="" class="readonly" style="width:92%; text-align:right;" readonly></td>
             </tr>
			</table></td>
		</tr>
