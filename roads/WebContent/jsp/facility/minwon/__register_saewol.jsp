            ...
            <td class="contborder_blue"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <tr>
					...
					<td width="37%" bgcolor="eaeaea" class="table_bl_left"><input name="REQ_NO" id="REQ_NO" type="text" class="readonly" style="width:120px" value="${REQ_NO}" readonly></td>
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="REQ_DATE" id="REQ_DATE" type="text" class="input_form1" style="width:65px" value="${REQ_DATE}" readonly></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="PREDATE" id="PREDATE" type="text" class="input_form1" style="width:65px" value="${PREDATE}" readonly></td>
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><input name="REQ_DEP" id="REQ_DEP" type="text" class="input_form1" style="width:120px"  value="${REQ_DEP}" readonly></td>
				  ...
				  <tr>
					...
					<td colspan="3" bgcolor="eaeaea" class="table_bl_left"><input name="NOTES" id="NOTES" type="text" class="input_form1" style="width:98%" value="${NOTES}"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">신청인</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="AGENT_NM" id="AGENT_NM" type="text" class="input_form1" style="width:250px" value="${AGENT_NM}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">신청인 연락처</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="AGENT_TEL" id="AGENT_TEL" type="text" class="input_form1" style="width:120px" value="${AGENT_TEL}" style="ime-mode:disabled" onKeyDown="nr_tel_num(this);" onKeyUp="nr_tel_num(this);" onKeyPress="nr_tel_num(this);"></td>
				  </tr>
			...
			<div class="tabcontent">
                ...
                <tr>
				  ...
				  <tr>
					...
					<td width="37%" bgcolor="eaeaea" class="table_bl_left"><input name="NAME" id="NAME" type="text" class="essential" style="width:250px" value="${NAME}"></td>
					<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">주민/법인번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="jumin_ssn1" id="jumin_ssn1" type="text" class="essential" style="width:40px; ime-mode:disabled" value="${jumin_ssn1}" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, jumin_ssn2, 6);" maxlength="6">
					  - <input name="jumin_ssn2" id="jumin_ssn2" type="text" class="essential" style="width:45px; ime-mode:disabled" value="${jumin_ssn2}" onKeyPress="nr_num_int(this);" maxlength="7"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">사업자등록번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="jumin_bizssn1" id="jumin_bizssn1" type="text" class="input_form1" value="${jumin_bizssn1}" style="width:20px; ime-mode:disabled" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, jumin_bizssn2, 3);" maxlength="3">
					  ...
					  - <input name="jumin_bizssn3" id="jumin_bizssn3" type="text" class="input_form1" value="${jumin_bizssn3}" style="width:35px; ime-mode:disabled" onKeyPress="nr_num_int(this);" maxlength="5">
					<td align="center" bgcolor="e5eff8" class="sub_table_b">업태/업종</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="BIZ_STATUS" id="BIZ_STATUS" type="text" class="input_form1" style="width:60px" value="${BIZ_STATUS}">
					  / <input name="BIZ_TYPES" id="BIZ_TYPES" type="text" class="input_form1" style="width:160px" value="${BIZ_TYPES}"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">우편번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<tr>
						  <td><input name="POST" id="POST" type="text" class="essential" style="width:50px" onFocus="Jumin_toaddr_Check();" value="${POST}" readonly></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><input name="ADDR1" id="ADDR1" type="text" class="essential" style="width:250px" onFocus="Jumin_toaddr_Check();" value="${ADDR1}" readonly>
						<input name="ADDR2" id="ADDR2" type="text" class="essential" style="width:250px" onKeyUp="Jumin_toaddr_Check();" value="${ADDR2}"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">e-mail</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="EMAIL" id="EMAIL" type="text" class="input_form1" style="width:250px" value="${EMAIL}" style="ime-mode:disabled" onKeyUp="Jumin_toaddr_Check();"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">도로명 주소 </td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="textfield2222723" id="textfield2222723" type="text" class="input_form1" style="width:100px">
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TEL" id="TEL" type="text" class="input_form1" style="width:120px" value="${TEL}" style="ime-mode:disabled" onKeyUp="nr_tel_num(this); Jumin_toaddr_Check();"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">휴대전화</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="HP" id="HP" type="text" class="input_form1" style="width:120px" value="${HP}" style="ime-mode:disabled" onKeyUp="nr_tel_num(this); Jumin_toaddr_Check();"></td>
				  </tr>
				  <tr>
					<td height="34" colspan="4" align="left" bgcolor="#FFFFFF" class=""><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<tr>
						  ...
						  <td width="16"><input name="checkbox" id="checkbox" type="checkbox" value="false" onclick="javascript:Jumin_toaddr_Check()"></td>
				  ...
				  <tr>
					...
					<td colspan="3" bgcolor="eaeaea" class="table_bl_left"><input name="TOPOST_NM" id="TOPOST_NM" type="text" class="input_form1" style="width:250px" value="${TOPOST_NM}"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">우편번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<tr>
						  <td><input name="TOPOST" id="TOPOST" type="text" class="input_form1" style="width:50px" value="${TOPOST}" readonly></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TOADDR1" id="TOADDR1" type="text" class="input_form1" style="width:250px" value="${TOADDR1}" readonly>
						<input name="TOADDR2" id="TOADDR2" type="text" class="input_form1" style="width:250px" value="${TOADDR2}"></td>
				  </tr>
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">e-mail</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TOEMAIL" id="TOEMAIL" type="text" class="input_form1" style="width:250px" value="${TOEMAIL}" style="ime-mode:disabled"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">도로명 주소 </td>
				  ...
				  <tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">전화번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TOTEL" id="TOTEL" type="text" class="input_form1" style="width:120px" value="${TOTEL}" style="ime-mode:disabled" onKeyDown="nr_tel_num(this);" onKeyUp="nr_tel_num(this);" onKeyPress="nr_tel_num(this);">
						</td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">휴대전화</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TOHP" id="TOHP" type="text" class="input_form1" style="width:120px" value="${TOHP}" style="ime-mode:disabled" onKeyDown="nr_tel_num(this);" onKeyUp="nr_tel_num(this);" onKeyPress="nr_tel_num(this);">
						</td>
				  </tr>
                  </table></td>
                </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
				...
				<tr>
				  ...
				  <td width="37%" bgcolor="eaeaea" class="table_bl_left"><select name="TYPE" id="TYPE" class="essential" style="width:70px" OnChange="Select_UseType(this);">
					${use_type}
			      </select></td>
				  <td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">점용구분</td>
				  <td width="36%" bgcolor="eaeaea" class="table_bl_left"><select name="SECTION" id="SECTION" class="essential" style="width:70px" OnChange="Select_UseSection(this);">
					${occupancy_type}
				  </select></td>
				</tr>
				<tr>
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					  <td>${SIGUNGU}&nbsp;&nbsp;</td>
                         <td width="72"><select name="BJ_CD" id="BJ_CD" class="essential" style="width:100px">
                           ${bjdong_code}
                         </select></td>  
                         <td>&nbsp;<select name="HJ_CD" id="HJ_CD" class="essential" style="width:100px">
                           ${hjdong_code}
                         </select></td>
                         <td>&nbsp;/&nbsp;<select name="SAN_CK" id="SAN_CK" class="essential" style="width:75px">
                           ${mul_spc_cd}
                         </select></td>
					  <td>&nbsp;<input name="BONBUN" id="BONBUN" value="${BONBUN}" type="text" class="essential" style="width:40px" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="4">
						...
						번지 <input name="TONG" id="TONG" value="${TONG}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="2">
						통 <input name="BAN" id="BAN" value="${BAN}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="2"> 
						반 </td>
					  </tr>
				  </table></td>
				</tr>
				...
				<tr>
				  ...
				  <td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					  <td><input name="MUL_POST" id="MUL_POST" type="text" class="essential" style="width:50px" value="${MUL_POST}" readonly></td>
				  ...
				  <td bgcolor="eaeaea" class="table_bl_left"><input name="BD_NM" id="BD_NM" type="text" class="input_form1" style="width:120px" value="${BD_NM}">
					<input name="BD_DONG" id="BD_DONG" type="text" class="input_form1" style="width:30px" value="${BD_DONG}" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);">
					동 <input name="BD_HO" id="BD_HO" type="text" class="input_form1" style="width:30px" value="${BD_HO}" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);">
					호 </td>
				</tr>
				
                <tr>
                  <td align="center" bgcolor="e5eff8" class="sub_table_b">도로명 주소</td>
                  <td bgcolor="eaeaea" class="table_bl_left"><input name="ROAD_ADD" id="ROAD_ADD" type="text" class="input_form1" style="width:140px" value="${ROAD_ADD}" maxlength="12"></td>
       			  
				  <td width="100" height="26" align="center" bgcolor="e5eff8" class="">
				  	<input name="USERTYPENAME" id="USERTYPENAME" type="text" style="width:95px" class="viewcol" value="주차면수">
				  </td>
				  	                      			  
       			  <td colspan="0" bgcolor="F6F6F6" class="table_bl_left">
	       			  <span id="UseType1" style="display:none">
		                  <table width="100%" border="0">
		                  	<input name="PARKING_NUM" id="PARKING_NUM" type="text" class="input_form1" style="width:40px" value="${PARKING_NUM}" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);"> 면
		                  </table>
	                  </span> 
	       			  <span id="UseType2" style="display:none">
		                  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_stan"> 
		                  	<input name="RIVER_NM" id="RIVER_NM" type="text" class="input_form1" style="width:100px" value="${RIVER_NM}">
		                  </table>
	                  </span>   
                  </td>
                </tr>
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					<td>
					  <input name="MUL_FROMDATE" id="MUL_FROMDATE" type="text" class="essential" style="width:70px" value="${MUL_FROMDATE}" readonly><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, MUL_FROMDATE, 'yyyymmdd')" style="CURSOR: Hand;"></a>
					   ~ <input name="MUL_TODATE" id="MUL_TODATE" type="text" class="essential" style="width:70px" value="${MUL_TODATE}" readonly><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, MUL_TODATE, 'yyyymmdd')" style="CURSOR: Hand;"></a></tr>
					</td>
					
	                <tr style="display:none" id="UseSection">
					  <td>일시점용<input name="PARTLY_PERIOD" id="PARTLY_PERIOD" type="text" class="essential" style="width:300px" value="${PARTLY_PERIOD}">
					  &nbsp;&nbsp;총<input name="TOTAL_PERIOD" id="TOTAL_PERIOD" type="text" class="essential" style="width:30px" value="${TOTAL_PERIOD}" style="ime-mode:disabled" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);">일</td>
					</tr>
				  </table></td>
				</tr>
			    ...
			    <tr>
				  ...
				  <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="WITH_POST" id="WITH_POST" value="${WITH_POST}" type="text" class="input_form1" style="width:50px" readonly></td>
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					 <input name="WITH_ADDR1" id="WITH_ADDR1" type="text" class="input_form1" style="width:200px" value="${WITH_ADDR1}" readonly>
					 <input name="WITH_ADDR2" id="WITH_ADDR2" type="text" class="input_form1" style="width:350px" value="${WITH_ADDR2}">
				  </table></td>
				</tr>
			    ...
			    <tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					  <td><input name="WORK_FROMDATE" id="WORK_FROMDATE" value="${WORK_FROMDATE}" type="text" class="input_form1" style="width:65px" readonly></td>
					  ...
					  <td><input name="WORK_TODATE" id="WORK_TODATE" value="${WORK_TODATE}" type="text" class="input_form1" style="width:65px" readonly></td>
				...
				<tr>
				  <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">공사내용</td>
					<td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<input name="EXE_INFO" id="EXE_INFO" type="text" class="input_form1" style="width:98%" value="${EXE_INFO}">
					</table></td>
			    </tr>
