...
<input type="hidden" name="LISTVIEW" id="LISTVIEW" value="${LISTVIEW}">
                  ...
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                      ...
                      <tr>
                        ...
                        <td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                            <tr>
                              <td><input name="GIGAN1" id="GIGAN1" type="text" class="input_form1" style="width:80px" value="${GIGAN1}" readonly></td>
                              ...
                              <td><input name="GIGAN2" id="GIGAN2" type="text" class="input_form1" style="width:80px" value="${GIGAN2}" readonly></td>
                        ...
                        <td bgcolor="eaeaea" class="table_bl_left">
                        	<input name="MIN_NAME" id="MIN_NAME" type="text" class="input_form1" style="width:200px" value="${MIN_NAME}" onkeypress="if(event.keyCode == 13) Search();">
                        </td>
<!--  
...
<%-- 
                      <tr>
                        ...
                        <td bgcolor="eaeaea" class="table_bl_left">
                        	<input name="MIN_REQNO" id="MIN_REQNO" type="text" class="input_form1" style="width:120px" value="${MIN_REQNO}" style="ime-mode:disabled" onkeypress="javascript:onCheck();" maxlength="18">
                        </td>
                        <td align="center" bgcolor="e5eff8" class="sub_table_b">민원인명</td>
                        <td bgcolor="eaeaea" class="table_bl_left">
                        	<input name="MIN_NAME" id="MIN_NAME" type="text" class="input_form1" style="width:200px" value="${MIN_NAME}" onkeypress="if(event.keyCode == 13) Search();">
