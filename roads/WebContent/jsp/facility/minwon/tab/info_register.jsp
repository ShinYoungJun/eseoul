                ...
                <tr>
					<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  	...
				  	<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  	<tr>
							<td><input name="REQ_DATE_MIN" id="REQ_DATE_MIN" type="text" class="input_form1" style="width:120px" value="${REQ_DATE_MIN}" ></td>
						...
						<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  	<tr>
							<td><input name="PREDATE_MIN" id="PREDATE_MIN" type="text" class="input_form1" style="width:120px" value="${PREDATE_MIN}" ></td>
					...
					<tr>
				 	...
				 	<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
							<tr>
							  	<td><input name="POST_MIN" id="POST_MIN" type="text" class="input_form1" style="width:50px" value="${POST_MIN}" ></td>
							</tr>
						</table></td>
						<td align="center" bgcolor="e5eff8" class="sub_table_b">민원인 주소</td>
						<td bgcolor="eaeaea" class="table_bl_left"><input name="ADDR1_MIN" id="ADDR1_MIN" type="text" class="input_form1" style="width:250px" value="${ADDR1_MIN}" >
			...
			<div class="tabcontent" style="display:none">
				<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
					...
					<!-- 기본 주소  -->
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<input id="ADDR1" name="ADDR1" type="text" class="essential" style="width:250px" value="${ADDR1}" readonly>
							산<input id="SAN" name="SAN" type="checkbox" style="vertical-align: middle;" readonly >
							<input id="BON" name="BON" type="text" class="essential" style="width:25px" value="${APPEAL_BON}" readonly/>
							-
							<input id="BU" name="BU" type="text" class="input_form1" style="width:25px" value="${APPEAL_BU}" readonly/>
							<input id="ADDR2" name="ADDR2" type="text" class="input_form1" style="width:135px" value="${ADDR2}"  maxlength="50" readonly/>
						</td>
					<!-- 도로명주소 -->
				  	...
				  	<!-- 송달지 주소 -->
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<input id="TOADDR1" name="TOADDR1" type="text" class="essential" style="width:250px" value="${TOADDR1}" readonly/>
							산<input id="TOSAN" name="TOSAN" type="checkbox" style="vertical-align: middle;" readonly/>
							<input id="TOBON" name="TOBON" type="text" class="essential" style="width:25px" value="${APPEAL_TOBON}" readonly/>
							-
							<input id="TOBU" name="TOBU" type="text" class="input_form1" style="width:25px" value="${APPEAL_TOBU}" readonly/>
							<input id="TOADDR2" name="TOADDR2" type="text" class="input_form1" style="width:135px" value="${TOADDR2}" maxlength="50" readonly/>
						</td>
					<!-- 송달지 도로명주소 -->
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<!--  //********** BEGIN_현진_20120215 -->
							<!-- 
								<input id="TOADDR1_NEW" name="TOADDR1_NEW" type="text" class="essential" style="width:250px" value="${TOADDR1}" readonly/>
							<input id="TOBON_NEW" name="TOBON_NEW" type="text" class="essential" style="width:25px" value="${APPEAL_TOBON}" readonly />
							-
							<input id="TOBU_NEW" name="TOBU_NEW" type="text" class="input_form1" style="width:25px" value="${APPEAL_TOBU}" readonly/>
							<input id="TOADDR2_NEW" name="TOADDR2_NEW" type="text" class="input_form1" style="width:135px" value="${TOADDR2}"  maxlength="50" readonly/>
							 -->
