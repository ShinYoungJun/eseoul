            ...
            <td class="contborder_blue"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  	...
				  	<tr>
						...
						<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">주민번호</td>
                ...
                <tr>
            		...
            		<tr>
                        ...
                        <td align="center" bgcolor="e5eff8" class="sub_table_b">업체번호</td>
						...
						<c:when test="${blist!= null && !empty blist}">
		                      <c:forEach items="${blist}" var="board" varStatus="idx">
			                     <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''">
		        					...
		        					<td align="center"><img src="/img/mod_icon3.gif" alt="조회" border="0" onclick="javaScript:Search();" style="CURSOR:Hand;"></td>
			                     </tr>
							 </c:forEach>
						</c:when>
						<c:otherwise>
