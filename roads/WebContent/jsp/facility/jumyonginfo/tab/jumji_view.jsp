...
//<![CDATA[
	...
	function choose_place(admin_no, object_no)
	{
		...
		var currentPage= document.getElementById("currentPage").value;
 		...
 		location.href="/facility/jumyonginfo/jumji_view.do?GU_CODE="+gu_code+"&CORP_CD="+corp_cd+"&currentPage="+currentPage+"&object_no="+object_no+"&ADMIN_NO="+admin_no;
	}
				  ...
				  <tr>
					<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
					    ...
					    <tr>
						  ...
						  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"  nowrap="nowrap">(우) ${sisul_post}&nbsp;&nbsp;${sisul_addr1}&nbsp;${sisul_addr2}&nbsp;${bunji}</td>
					    </tr>
					    <tr>
						  <td height="34" colspan="4" align="left" bgcolor="#FFFFFF" class=""><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
							<tr>
