 ...
 //   		if(document.getElementById("DEPTH_CK").checked	== true)
  //  			DEPTH_CK	= "1";
    		...
    		/*for(var i = 1; i<listCount+1;i++){
    			...
    			objNode.appendChild(setNode(xmlDom, "seq"+i));
    			objNode.appendChild(setNode(xmlDom, "tax_set"+i));
    		}
...
//    		parent.Tab_Img("jumji");
    ...
    <body onload="Init()">
        <form id="frm" name="frm" method="post" action="/facility/jumyong/productIlgwalInsert.do" >
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <div style="width:730px;height:500px; padding:10px;overflow:scroll; scrollbar-face-color:#EEF8FB;  scrollbar-3dlight-color:#BBBDB6;scrollbar-highlight-color:#EEF8FB;scrollbar-shadow-color:#BBBDB6; scrollbar-darkshadow-color:#EEF8FB;  scrollbar-track-color:#EEF8FB; scrollbar-arrow-color:#BBBDB6;">
                                                                        ...
                                                                        <c:when test='${blist != null && !empty blist}'>
                                                                            <c:forEach items="${blist}" var="board" varStatus="idx">
                                                                                    ...
                                                                                    <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''">
				                                                                        ...
				                                                                        <td align="center" class="sub_table_b"><input id='quantity${idx.count}' name='QUANTITY_ILGW' type='text' value='${board.QUANTITY}'size='5' class="sub_table_b"></td>
				                                                                        <td align="center" class="sub_table_b"><input id='depth_num${idx.count}' name='DEPTH_NUM' type='text' value='${board.DEPTH_NUM}'size='2' class="sub_table_b">%</td>
				                                                                        <td align="center" class="sub_table_b">${board.TAX_SET_NAME}</td>
				                                                                        <td align="center" class="sub_table_b"><input id='momey${idx.count}' name='RATE_ILGW' type='text' value='${board.MOMEY }'size='10' class="sub_table_b"></td>
				                                                                        <td align="center" class="sub_table_b"><input id='calculation${idx.count}' name='FORM_ADJUST' type='text' value=''size='50' class="sub_table_b"></td>
				                                                                        <td align="center" class="sub_table_b"><input id='jumyong${idx.count}' name='SUM_ADJUST_ILGW' type='text' value='' class="sub_table_b"></td> 
                                                                                    </tr>
                                                                                		<input id='object_no${idx.count}' name='OBJECT_NO' type='hidden' value='${board.OBJECT_NO}' >
                                                                                		<input id='tax_set${idx.count}' name='TAX_SET' type='hidden' value='${board.TAX_SET}' >
                                                                            </c:forEach>
                                                                        </c:when>
                                                                        <c:otherwise>
                                                                            <tr>
                                    ...
                                    <table border="0" width="100%">
                                        <tr>
                                            <td height="40" align="right">
                                                ...
                                                <img src="/img/save_icon2.gif" alt="저장" width="56" height="18" border="0" onClick="javascript:IlgwSumit();" style="vertical-align:middle;cursor:pointer">
