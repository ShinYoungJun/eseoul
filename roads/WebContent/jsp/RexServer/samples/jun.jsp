...
<script language="JavaScript">
	function fnOpenRexViewerJavaScript1() {
		var oRptMainParam;
		oRptMainParam = rex_GetgoDictionay();

		// 필수 - 레포트명

		oRptMainParam.put("rex_rptname", "samples/test");

		// 필수 - 데이터 타입 설정
		oRptMainParam.put("rex_datatype", "CSV");  // XML, CSV, CSVSTR
...
<body>
	<button id="btnRexViewer" onclick="fnOpenRexViewerJavaScript1();">레포트 보기</button><br>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<br>
