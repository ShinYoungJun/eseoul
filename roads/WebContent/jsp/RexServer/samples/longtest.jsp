...
<script language="JavaScript">
	...
	function fnOpenRexViewerJavaScript() {
		...
		// 필수 - 레포트명
		oRptMainParam.put("rex_rptname", "http://localhost:8080/RexServer/samples/longtest.rex");
		
		// 필수 - 데이터 타입 설정
		oRptMainParam.put("rex_datatype", "CSV");  // XML, CSV

		// 옵션 - 다른 DB를 연결시
		oRptMainParam.put("rex_userservice", "Sql3");
		
		oRptMainParam.put("rex_split_fields", "main=a:0");
