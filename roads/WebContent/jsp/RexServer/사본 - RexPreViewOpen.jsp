...
<script language="JavaScript">
	...
	function fnOpenRexViewerJavaScript() {
		...
		// 옵션 - 데이터 및 xpath 설정
		//oRptMainParam.put("rex_data", "http://124.137.28.135:8080/RexServer/rexfiles/DVD.xml");
		...
		// 필수 - 레포트명
		//oRptMainParam.put("rex_rptname", "DVD");
		//oRptMainParam.put("rex_rptname", "Rexpert1(UNICODE)");
		//oRptMainParam.put("rex_rptname", "Rexpert1(ANSI)");
