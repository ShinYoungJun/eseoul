   ...
   //     xmldoc.async	= "false";
        ...
        if(defaultSel	< 0)
        	selectBoxLabel	= "";
  			...
  			selectBoxLabel = xmldoc.getElementsByTagName("option/@label").item(defaultSel).text;
...
<input type="hidden" name="PURPOSE_CD" value="<%=PURPOSE_CD_TEXT%>">
<input type="hidden" name="PURPOSE1" value="">
<input type="hidden" name="PURPOSE2" value="">
<input type="hidden" name="PURPOSE3" value="">

<td>
	<input name="PURPOSE_NM" type="text" class="view" style="width:630px" value="<%=PURPOSE_CD_TEXT%>" readonly>
</td>
