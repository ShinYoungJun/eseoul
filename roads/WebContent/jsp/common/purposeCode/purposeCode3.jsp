...
//<![CDATA[
	...
	function	Search_Result_Kind_input(obj)
	{
		...
		else
		{
			if(ClassCode == 0)
			{
				document.getElementById("PURPOSE1").options[document.getElementById("PURPOSE1").selectedIndex].label=="공유재산물품관리법"
			}
			else
			{
...
<tr>
<td bgcolor="eaeaea">
	<select name="PURPOSE1" id="PURPOSE1" class="input_form1" style="width:136px" OnChange="Selected_Sort()" onkeyup="javascript:PurposeCode_Search();">
	</select>
</td>
</tr>
<tr>
<td bgcolor="eaeaea">
	<select name="PURPOSE2" id="PURPOSE2" class="input_form1" style="width:136px" OnChange="Selected_Kind()">
	</select>
</td>
</tr>
<tr>
<td bgcolor="eaeaea">
	<select name="PURPOSE3" id="PURPOSE3" class="input_form1" style="width:136px" OnChange="Selected();">
	</select>
</td>
</tr>
</table>
