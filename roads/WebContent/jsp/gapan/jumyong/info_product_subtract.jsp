...
//	     alert(sdate+"   "+edate);
	...
	function goView(year,seq)
	{
		...
		location.href('/gapan/jumyong/productSubtractInsert.do?no=${no}&year='+year+'&currentPage=${currentPage}&countPerPage=${countPerPage}&seq='+seq+'&section=${section}');
	}
...
<form name="productForm" id="productForm" method="post" action = "/gapan/jumyong/productSubtractInsert.do" >
			<input name="no" value="${no}" type="hidden" >
			<input name="mode"  id = "mode" value="${mode}" type="hidden" >
			<input name="SEQ"  id = "SEQ" value="${seq}" type="text" >			
			...
			<spring:bind path="product.CAL_SUM_SEQ">
				<input name="CAL_SUM_SEQ"  id = "CAL_SUM_SEQ" value="${product.CAL_SUM_SEQ}" type="text" >			
			</spring:bind>
							              ...
							              <tr>              
							                <td height="40" align="right">
								                <table border="0" width="100%">
								                	<tr>
								                	<td >
									                <a href="/gapan/jumyong/productInsert.do?no=${no}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}&mode=add&section=${section}">
			...
			<spring:bind path="product.PRICE" >
				price<input name="PRICE" ID="PRICE" value="${product.PRICE}" type="text"  style="width:80px;ime-mode:disabled;" >	 						                   		
			</spring:bind>
		 	<spring:bind path="product.RATE">
				rate<input name="RATE"  id="RATE" type="text" style="width:80px;ime-mode:disabled;" value="${product.RATE}"  >
			</spring:bind>		         
			<spring:bind path="product.ADJUSTMENT">
				adjustment<input name="ADJUSTMENT" id="ADJUSTMENT" type="text" class="input_form1" style="width:120px;ime-mode:disabled;" value="${product.ADJUSTMENT}"   onKeyDown="onlyNumberInput();" style="text-align:right">
			</spring:bind>
			<spring:bind path="product.SUM_LASTYEAR">
            	sum_lastyear<input name="SUM_LASTYEAR" id="SUM_LASTYEAR" type="text"  class="input_form1" style="width:80px;ime-mode:disabled;" value="${product.SUM_LASTYEAR}"   onKeyDown="onlyNumberInput();" onkeyup="javascript:fn_addComma(this)" style="text-align:right">원
			</spring:bind>
			<spring:bind path="product.FORM">                                        
				form<input name="FORM" ID="FORM" type="text" class="input_form1" style="width:300px" value="${product.FORM}">
			</spring:bind>
			<spring:bind path="product.SUM_YEAR">
				sum_year<input name="SUM_YEAR" id="SUM_YEAR" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" value="${product.SUM_YEAR}"   onKeyDown="onlyNumberInput();" onkeyup="javascript:fn_addComma(this)" style="text-align:right">원
			</spring:bind>
