          ...
          <tr>
            <td height="22" background="/img/tab_line_purple.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="111" onclick ="javascript:location.href='/jsp/gapan/jumyong/info_placeDetail.jsp?no=${no}'"><img src="/img/sub_petition_title7_off.gif" alt="첨부자료" width="110" height="22" border="0" style="cursor:pointer" > </td>
                  <td width="111" onclick ="javascript:location.href='/jsp/gapan/jumyong/info_history.jsp?no=${no}'"><img src="/img/sub_petition_title8_on.gif" alt="이력정보" width="110" height="22" border="0" style="cursor:pointer" > </td>
                 </tr>
            </table></td>
          </tr>
