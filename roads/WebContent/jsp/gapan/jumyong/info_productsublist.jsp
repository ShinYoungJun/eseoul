...
function gosub(seq,year,taxyn,first_seq)
{
	...
	if(taxyn == "Y")	
		sData.document.location.href ="/gapan/jumyong/productSubtractInsert.do?no="+"${ADMIN_NO}"+"&mode=add&SEQ="+seq+"&area=${area}";
	else
	{
		alert("부과전 감소");
		sData.document.location.href ="/gapan/jumyong/productSubtractBeforeTaxInsert.do?no="+"${ADMIN_NO}"+"&mode=add&SEQ="+seq+"&area=${area}&year="+year1;	
		}
		/*
	else
	{
