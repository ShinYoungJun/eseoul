    ...
    <head>
        ...
        <script>
            ...
            function InitPage()
            {
            	...
            	if('${ck_del}' == '1'){
                    location.href = "/gapan/jumyong/rentalInsert.do?GAPAN_NO=${GAPAN_NO}";
                }
            ...
            function goModify()
            {
                ...
                location.href = "/gapan/jumyong/rentalInsert.do?GAPAN_NO=${GAPAN_NO}&currentPage=${currentPage}&countPerPage=${countPerPage}"
                ...
                if(reduction_rate == "0.0" || reduction_rate == "0" || reduction_rate == ""){
                	...
                	sum_adjust.value = Math.floor(fixFloatCal(parseFloat(sum_year.value)*parseFloat((100-parseFloat(reduction_rate))/100)));
                   	form_adjust.value = form.value+" X (100-"+reduction_rate+")/100";
								...
								<%-- 2013-04-29 김성호  대부료 산출내역 감면임대료,부가세 100단위로 절삭[강서구 요청사항]--%> 
            ...
            function goDelete()        {
                location.href("/gapan/jumyong/rentalInsert.do?GAPAN_NO=${GAPAN_NO}&seq=${seq}&mode=del");
                                    ...
                                    <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                        ...
                                        <c:forEach items="${productList}" var="board" varStatus="idx">
                                            <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''"
                                                onclick="javascript:setParentYear('${board.YEAR}');location.href('/gapan/jumyong/rentalInsert.do?GAPAN_NO=${GAPAN_NO}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}&year=${board.YEAR}&seq=${board.SEQ}&SECTION=${SECTION}');" style="cursor:pointer" >
                                    ...
                                    <td>
                                        <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                            ...
                                            <tr>
                                                ...
                                                <td width="13%" height="26" align="center" bgcolor="e5eff8" class="sub_table_b">시설물가액</td>
                                                <td width="32%" bgcolor="eaeaea" class="table_bl_left" >
                                                    <input name="PRICE" ID="PRICE" value="${rnic:insertComma2(product.SF_VALUE)}" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" onkeyup="javascript:fn_addComma(this)"  onKeyDown="onlyNumberInput();" style="text-align:right">원
                                                </td>
                                            </tr>
