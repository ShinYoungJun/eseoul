							              ...
							              <tr>
							                ...
							                <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
							                  ...
							                  <c:forEach items="${impositionList}" var="board" varStatus="idx">
							                      ...
							                      onclick="javascript:location.href('/gapan/junggi/junggi_product.do?ADMIN_NO=${no}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}}');" style="cursor:pointer" >
								                ...
								                <table border="0" width="100%">
								                	...
								                	<td >
  									                <c:if test="${showAdd == 'true'}"> 								                	
										                <a href="/gapan/junggi/junggi_product.do?ADMIN_NO=${no}&year=${year}&currentPage=${currentPage}&countPerPage=${countPerPage}&mode=add";">
