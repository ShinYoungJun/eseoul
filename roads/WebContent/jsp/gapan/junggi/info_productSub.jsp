...
//		form.FORM_ADJUST.value	=	xmldoc.getElementsByTagName("FORM_ADJUST").item(0).text;
	...
	function goModify()
	{
		...
		location.href = "/gapan/junggi/junggi_product.do?ADMIN_NO=${no}&year=${year}&currentPage=${currentPage}&countPerPage=${countPerPage}"
		+"&mode=edit";
...
//		+"&mode=edit&year="+year+"&seq="+seq+"&section=${section}";
	...
	{
		var seq = document.getElementById("SEQ").value;
		location.href("/gapan/junggi/junggi_product.do?ADMIN_NO="+adminNo+"&SEQ="+seq+"&currentPage="+currentPage+"&mode=add");
	}
	...
	{
		var seq = document.getElementById("SEQ").value;
		location.href("/gapan/junggi/junggi_product.do?ADMIN_NO="+adminNo+"&SEQ="+seq+"&currentPage="+currentPage+"&mode=edit");
	}
	...
	{
		location.href("/gapan/junggi/junggi_view.do?ADMIN_NO="+adminNo+"&SEQ="+seq+"&currentPage="+currentPage+"&year="+year);
...
<form name="productForm" id="productForm" method="post" action = "/gapan/jumyong/productSubtractBeforeTaxInsert.do" >
