...
//<![CDATA[
	...
	//	var	seq		= document.getElementById("TAX_NO").value;
		...
		tabs.src	= "/gapan/junggi/junggi_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;// + "&SEQ=" + seq;
	}
  ...
  <tr>
	...
	<!--상단 기안문상신,도움말 메뉴-->		
      ...
      <tr>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tabUp" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/gapan/junggi/junggi_view.do?ADMIN_NO=${ADMIN_NO}"></iframe>
		</td>
