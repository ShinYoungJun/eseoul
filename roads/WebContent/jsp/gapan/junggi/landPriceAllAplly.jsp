...
<form name="form1" id="form1" action="/gapan/junggi/priceApplyUpdate.do">
<input type="hidden" name="currentPage" value="${currentPage}">
<input name="YEAR" id="YEAR" type="hidden" value="${year}">
<input name="TYPE" id="TYPE" type="hidden" value="${type}">
<input name="TAX_SET" id="TAX_SET" type="hidden" value="${tax_set}">
<input name="TAX_YN" id="TAX_YN" type="hidden" value="${tax_yn}">
<input name="MUL_FROMDATE" id="MUL_FROMDATE" type="hidden" value="${mul_fromdate}">
<input name="MUL_TODATE" id="MUL_TODATE" type="hidden" value="${mul_todate}">
<input name="PURPOSE" id="PURPOSE" type="hidden" value="${purpose}">
<input name="BJ_CD" id="BJ_CD" type="hidden" value="${bj_cd}">
<input name="cal_status" id="cal_status" type="hidden" value="${cal_status}">
<input name="jumyongName" id="jumyongName" type="hidden" value="${jumyongName}">
	        		...
	        		<td>
	        			<table width="100%" border="2" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                    		...
                    		<tr>
                    			...
                    			<td align="center">${board.BJ_NM} ${board.WITH_ADDR}</td>
