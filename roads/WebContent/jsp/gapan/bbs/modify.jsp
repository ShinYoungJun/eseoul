...
<form action="gapan_update.action" method="post"	enctype="multipart/form-data">
		...
		<td class="contborder_blue">
			...
			<tr>
				<td align="right">
					...
					<input type="button" value=" 취소" onclick="location.href='gapan_content.action?sid=${dto.sid }'">
				</td>
			</tr>
		</td>
	</tr>
