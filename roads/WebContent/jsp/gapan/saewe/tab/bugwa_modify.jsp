...
//<![CDATA[
	...
	function	ModifyPrc()
	{
		...
		form.action = "/gapan/saewe/bugwa_modify_prc.do";
		form.submit();
	}
	...
	function	Cancel()
	{
		...
		form.action = "/gapan/saewe/bugwa_view.do";
		form.submit();
	}
			...
			<tr>
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				...
				<tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="SIGU_CD" type="text" class="readonly" style="width:45px" value="${board.SIGU_CD}" readonly></td>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="DEPT_CD" type="text" class="readonly" style="width:45px" value="${board.DEPT_CD}" readonly></td>
