...
<input type="hidden" id="GAPAN_NO" value="${GAPAN_NO}">
<input type="hidden" id="SEQ" value="${SEQ}">
<input type="hidden" id="TAX_YN" value="${TAX_YN}">
<input type="hidden" id="VIEWPAGE" value="VIEWPAGE">

<input type="hidden" id="sigu_cd" value="${board.SIGU_CD}">
<input type="hidden" id="buseo_cd" value="${board.DEPT_CD}">
<input type="hidden" id="semok_cd" value="${semok_cd}">
<input type="hidden" id="tax_ym" value="${tax_ym}">
<input type="hidden" id="tax_gubun" value="${board.TAX_GUBUN}">
<input type="hidden" id="tax_no" value="${board.TAX_NO}">
<input type="hidden" id="user_id" value="${user_id}">
<input type="hidden" id="bukwa_id" value="${bukwa_id}">
			...
			<tr>
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				...
				<tr>
					...
					<td width="181" bgcolor="eaeaea" class="table_bl_left">${board.SISE} 원</td>
					<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">구세</td>
					<td bgcolor="eaeaea" class="table_bl_left">${board.GUSE} 원</td>
				</tr>
