                ...
                <tr>
				   ...
				   <tr>
					...
					<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<input name="NAME_MIN" type="text" class="essential" style="width:120px" value="${NAME_MIN}">
						</td>
				        ...
				        <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				          ...
				          <tr>
							...
							<td bgcolor="f6f6f6" class="table_bl_left" nowrap>
								<input name="WITH_ADDR" type="text" class="essential" style="width:264px" value="${WITH_ADDR}" maxlength="50">
							</td>
				          ...
				          <tr>
				            ...
				            <td bgcolor="f6f6f6" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
				              <tr>
				                <td><select name="FT_TYP" class="essential" style="width:100px">
				                 ${ft_typ}
				                </select></td>
				                <td width="16" align="center">/</td>
				          ...
				          <tr>
				            ...
				            <td bgcolor="f6f6f6" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
				              <tr>
				                <td><input name="PLACE_L" type="text" class="input_form1" style="width:40px" onKeyPress="nr_num_float(this);" onKeyUp="nr_num_float(this);" maxlength="5"></td>
				                <td width="16" align="center">m</td>
				                <td width="12" align="center">x</td>
				                <td><input name="PLACE_H" type="text" class="input_form1" style="width:40px" onKeyPress="nr_num_float(this);" onKeyUp="nr_num_float(this);" maxlength="5"></td>
				                <td width="16" align="center">m</td>
				                <td width="12" align="center">=</td>
				                <td><input name="PLACE_A" type="text" class="input_form1" style="width:40px" onKeyPress="nr_num_float(this);" onKeyUp="nr_num_float(this);" maxlength="5"></td>
				                <td width="16" align="center">㎡</td>
				              </tr>
				            </table></td>
				          </tr>
				          ...
				          <tr>
				            ...
				            <td bgcolor="f6f6f6" class="table_bl_left"><select name="UN_TYP" class="input_form1" style="width:76px">
				             ${un_typ}
				              ...
				              <input name="UN_TXT" type="text" class="input_form1" style="width:158px" style="ime-mode:disabled" maxlength="50"></td>
				          </tr>
				          <tr>
				            <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">기타정보</td>
				            <td colspan="3" bgcolor="f6f6f6" class="table_bl_left"><input name="NOTES" type="text" class="input_form1" style="width:620px" style="ime-mode:disabled" maxlength="255"></td>
				            </tr>
				    </table>
			</div>
