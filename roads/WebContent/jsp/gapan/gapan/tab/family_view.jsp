...
//<![CDATA[
	...
	function goModify()
	{
		location.href = "/jsp/gapan/gapan/tab/family_modify.jsp";
	}
...
<table width="780" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
			    ...
			    <tr>
				  ...
				  <table width="100%"border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					  ...
					  <td><span class="sub_stan_blue">* 실제거주지</span></td> 
					</tr>
				  </table></td>
			    </tr>
				...
				<tr style="display:block" id="UseType1">
				  ...
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_POST}</td>
				  <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">우편번호</td>
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_TOPOST}</td>
				</tr>
				
				<tr style="display:block" id="UseType1">
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">기본주소 </td>
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_ADDR1}</td>
				  <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">기본주소</td>
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_TOADDR1}</td>
				</tr>
				
				<tr style="display:block" id="UseType1">
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">상세주소</td>
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_ADDR2}</td>
				  <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">상세주소</td>
				  <td bgcolor="eaeaea" class="table_bl_left">${info.PARTN_TOADDR2}</td>
				</tr>
          ...
          <tr>
		  	<td height="40" align="right"><a href="javascript:goModify();"><img src="/img/mod_icon.gif" alt="수정" width="56" height="18" border="0"></a>
		  	</td>
		  </tr> 
