	    ...
	    <table width="780" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td align="left">
		          	<tr>
		  				<TD>
			  				<iframe width="100%" height="100%" id="tab1" name="tab1" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/gapan/gapan/info_register.do"></iframe>
		  				</TD>
		          	</tr>
				</td>
			</tr>
			...
			<tr>
		        <td align="left">
			        <table width="780" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>
							  	<iframe width="100%" height="100%" name="tab2" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/gapan/gapan/jumji_search.do?NAME="+${NAME_MIN} + "&SSN1=" + ${minwon_ssn1} + "&SSN2=" + ${minwon_ssn2}></iframe>
							</td>
						</tr>
					</table>
				</td>
