...
//<![CDATA[
	...
	function	View(adminno, gpTyp, seq)
	{
		params	= "ADMIN_NO=" + adminno + "&GP_TYP=" + gpTyp + "&SEQ=" + seq;
		
		sendRequest("/gapan/jumyonginfo/minwon_view_search.do", params, "GET", Result_InfoView);
	}
	...
	function	Modify()
	{
		...
		form.action = "/gapan/jumyonginfo/minwon_modify.do";
		form.submit();
	}
	...
	function 	Init()
	{
		...
		if(SEQ !="") View(ADMIN_NO, GP_TYP, SEQ);
			...
			<tr>
				<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
			  	<tr>
					...
					<td width="37%" bgcolor="eaeaea" class="table_bl_left"><input name="REQ_NO_MIN" type="text" class="view" style="width:120px" readonly value="${REQ_NO}"></td>
					<td width="100" align="center" bgcolor="e5eff8" class="sub_table_b">민원구분</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="GUBUN_MIN" type="text" class="view" style="width:120px" readonly value="${GUBUN}"></td>
			  	</tr>
			  	<tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">접수일자</td>
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
				  	<tr>
						<td><input name="REQ_DATE_MIN" type="text" class="view" style="width:120px" readonly value="${REQ_DATE}"></td>
				  	</tr>
					</table></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">처리예정일자</td>
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
				  	<tr>
						<td><input name="PREDATE_MIN" type="text" class="view" style="width:120px" readonly value="${PRE_DATE}"></td>
				  	</tr>
					</table></td>
			  	</tr>
			  	...
			  	<tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><input name="REQ_DEP_MIN" type="text" class="view" style="width:120px" readonly value="${REQ_DEP}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">담당부서</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="MANAGE_DEP_MIN" type="text" class="view" style="width:120px" readonly value="${MANAGE_DEP}"></td>
			  	</tr>
			  
				<tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">접수자명</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="REQ_NM_MIN" type="text" class="view" style="width:120px" readonly value="${REQ_NM}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">담당자명</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="MANAGER_MIN" type="text" class="view" style="width:120px" readonly value="${MANAGER}"></td>
				</tr>
				<tr>
					...
					<td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<input name="NOTES_MIN" type="text" class="view" style="width:98%" readonly value="${NOTES}">
					</table></td>
				</tr>
				
				<tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">대리인</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="AGENT_NM_MIN" type="text" class="view" style="width:120px" readonly value="${AGENT_NM}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">대리인 연락처</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="AGENT_TEL_MIN" type="text" class="view" style="width:120px" readonly value="${AGENT_TEL}"></td>
				</tr>

				<tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">민원인명</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="NAME_MIN" type="text" class="view" style="width:120px" readonly value="${NAME}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">민원인 주민번호</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="SSN_MIN" type="text" class="view" style="width:120px" readonly value="${SSN}"></td>
				</tr>
			 	...
			 	<tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						<tr>
						  	<td><input name="POST_MIN" type="text" class="view" style="width:50px" readonly value="${POST}"></td>
						</tr>
					</table></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">민원인 주소</td>
					<td bgcolor="eaeaea" class="table_bl_left">
						<input name="ADDR1_MIN" type="text" class="view" style="width:250px" readonly value="${ADDR1}">
						<input name="ADDR2_MIN" type="text" class="view" style="width:250px" readonly value="${ADDR2}">
					</td>
			  	</tr>
			  	<tr>
					<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">민원인 전화</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="TEL_MIN" type="text" class="view" style="width:120px" readonly value="${TEL}"></td>
					<td align="center" bgcolor="e5eff8" class="sub_table_b">민원인 휴대폰</td>
					<td bgcolor="eaeaea" class="table_bl_left"><input name="HP_MIN" type="text" class="view" style="width:120px" readonly value="${HP}"></td>
			  	</tr>
