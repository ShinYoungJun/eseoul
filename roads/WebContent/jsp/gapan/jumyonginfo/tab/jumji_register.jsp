				...
				<tr>
					...
					<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
						...
						<tr>
							...
							<tr>
								<td>
									<input name="DEPTH_CK" type="text" class="input_form1" style="width:50px" onKeyUp="Select_Depth(); nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="3">&nbsp;
									<input name="DEPTH_NUM" type="text" class="input_form1" style="width:50px" readonly> %
								</td>
							</tr>
							</table></td>
						 </tr>
						 ...
						 <tr>
							...
							<td colspan="3" bgcolor="eaeaea" class="table_bl_left">
								<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									<tr>
										<td><input name="SISUL_POST" type="text" class="essential" style="width:50px" onFocus="Jumin_toaddr_Check();" readonly maxlength="7"></td>
										...
										<td bgcolor="eaeaea" class="table_bl_left"><input name="SISUL_ADDR1" type="text" class="essential" style="width:250px" onFocus="Jumin_toaddr_Check();" readonly maxlength="50">
										<input name="SISUL_ADDR2" type="text" class="essential" style="width:250px" maxlength="50"></td>  
									</tr>
								</table>
							</td>
						 </tr>
						 ...
						 <tr>
							...
							<td bgcolor="eaeaea" class="table_bl_left">
								<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
								<tr>
									<td><input name="COMPLETION_DATE" type="text" class="input_form1" style="width:65px" readonly></td>
									<td><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('COMPLETION_DATE'), 'yyyymmdd')" style="CURSOR: Hand;"></a></td>
								</tr>
								</table>
							</td>
						 </tr>
						 ...
						 <tr>
							...
							<td colspan="3" bgcolor="eaeaea" class="table_bl_left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									<input name="EXE_INFO" type="text" class="input_form1" style="width:98%" maxlength="100">
								</table>
							</td>
						 </tr>
						</table>
