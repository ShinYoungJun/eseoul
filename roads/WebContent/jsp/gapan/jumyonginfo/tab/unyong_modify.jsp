				  ...
				  <td>
	                ...
	                <tr>
						...
						<tr>
					  	...
					  	<tr>
							...
							<td bgcolor="eaeaea" class="table_bl_left">
								...
								&nbsp;( <input name="OWNER_AGE" class="input_form1" type="text" style="width:20px" maxlength="3" value="${board.OWNER_AGE}" onKeyPress="nr_num_int(this);" onKeyUp="nr_num_int(this);"> 세)
							</td>
					  	</tr>
					  	<tr>
						...
						<!--   //********** END_현진_20120212 -->					  	
					  	<tr>
					  	 <!-- 주민등록지 기본 주소 -->
							<td align="center" bgcolor="e5eff8" class="sub_table_b">기본 주소${board.OWNER_SAN}</td>
							<td bgcolor="eaeaea" class="table_bl_left">
						...
						<tr>
							...
							<td bgcolor="eaeaea" class="table_bl_left" nowrap="nowrap" colspan="3">
								<input name="ESTATE_MOVE" type="text" class="input_form1" style="width:90px" value="${board.ESTATE_MOVE}" maxlength="15" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);  comma_paste(this);" onKeyPress="nr_num_int(this);"> 원 / 
								<input name="ESTATE_REAL" type="text" class="input_form1" style="width:90px" value="${board.ESTATE_REAL}" maxlength="15" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);  comma_paste(this);" onKeyPress="nr_num_int(this);"> 원
							</td>
