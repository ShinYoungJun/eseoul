...
//<![CDATA[
	...
	function	Search()
	{
		...
		form.target	= "_self";
		form.action = "/junggi/gigan/search.do";
	...
	function Tab_Ilgwal()
	{
		...
		form.target	= 'tabUp';
		form.action = "/junggi/gigan/ilgwal_view.do";
...
//		tabs.src	= "/junggi/gigan/annae_view.do";

		var form = document.form;
		
		form.target	= 'tabDown';
		form.action = "/junggi/gigan/annae_view.do";
	...
	//	var tabs	= document.getElementById("tabDown");
	//	tabs.src	= "/junggi/gigan/giganilgwal_view.do";//?ADMIN_NO=" + adminno + "&SEQ=" + seq;'

		var form = document.form;
		
		form.target	= 'tabDown';
		form.action = "/junggi/gigan/giganilgwal_view.do";
