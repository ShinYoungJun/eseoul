...
//<![CDATA[
	...
	//	var	seq		= document.getElementById("TAX_NO").value;
		...
		tabs.src	= "/junggi/imposition/imposition.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;// + "&SEQ=" + seq;
	}
...
//		tabs.src	= "/jumyong/saewe/bugwa_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;
		tabs.src	= "/junggi/imposition/bugwa_view.do?ADMIN_NO=" + adminno + "&SEQ=" + seq;		
	...
	<!--상단 기안문상신,도움말 메뉴-->		
      ...
      <tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111"><a href="javascript:Tab_Sanchul('${ADMIN_NO}')"><img name="sanchul_img" src="/img/sub_petition_title16_on.gif" alt="산출 정보" width="110" height="22" border="0"></a></td>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tabUp" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/junggi/imposition/imposition.do?ADMIN_NO=${ADMIN_NO}"></iframe>
		</td>
      ...
      <tr>
          ...
          <tr>
            <td height="22" background="/img/tab_line_blue.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="111"><a href="javascript:Tab_Sunap('${ADMIN_NO}')"><img name="history_img" src="/img/sub_petition_title8_off.gif" alt="이력 정보" width="110" height="22" border="0"></a></td>
                </tr>
            </table></td>
          </tr>
		...
		<tr>
			<td height="40" align="right"><a href="javascript:SaeweSuipBugwa()"><img src="/img/levy_icon.gif" alt="세외수입부과" width="94" height="22" border="0"></a>
