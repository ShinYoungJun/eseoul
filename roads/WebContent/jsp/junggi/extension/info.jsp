          ...
          <tr>
            <td height="22" background="/img/tab_line_purple.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="111" onclick="subTabClick('topTapDiv1','topTapDiv2');"><a href="#"><img src="/img/sub_petition_title3_off_b.gif" alt="점용지 정보" width="110" height="22" border="0"></a></td>
          ...
          <tr>
            <td height="22" background="/img/tab_line_purple.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="111" onclick="subTabClick('topTapDiv2','topTapDiv2');"><a href="#"><img src="/img/sub_petition_title3_on_b.gif" alt="점용지 정보" width="110" height="22" border="0"></a></td>
                  <td align="right" class="sub_stan">관리번호 : ******_*_***** </td>
                </tr>
            </table></td>
          </tr>
              ...
              <tr>
                <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                    ...
                    <tr>
                      ...
                      <td bgcolor="eaeaea" class="table_bl_left"> <input name="textfield2222723322" type="text" class="input_form1" style="width:100px"></td>
...
<div id="divSub1" style="position:absolute;left:20px;top:500px;width:100%;z-index:4">
<table width="780" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="22" background="/img/tab_line_purple.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                 <td width="111" onclick ="subTabClick('divSub1','divSub1')"><a href="#"><img src="/img/sub_periodi_title5_on.gif" alt="기간 연장" width="110" height="22" border="0"></a></td>
          ...
          <tr>
            <td align="center" class="contborder_blue"><table width="100%" border="0" cellspacing="0" cellpadding="0">

                <tr>
                  <td height="34" >
                  <span class="sub_stan_blue">* 기간만료 통보</span>
		        ...
		        <tr>
				  <td height="40" align="right">
				  <a href="#"><img src="/img/print_icon.gif" alt="안내문 출력" width="94" height="22" border="0"></a></td>
		        </tr>	

                <tr>
                  <td height="34" ><span class="sub_stan_blue">* 점용기간 연장 </span></td>
                </tr>
                <tr>
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                      <tr>
                        ...
                        <td align="center" bgcolor="e5eff8" class="sub_table_b">비고</td>
                    ...
                    <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''">
                      ...
                      <td align="center"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                          <td><input name="textfield222242" type="text" class="input_form1" style="width:70px"></td>
                          <td><a href="#"><img src="/img/calendar_icon.gif" width="19" height="16" border="0"></a></td>
                      </table></td>
                      ...
                      <td align="center"><input name="textfield22223232235" type="text" class="input_form1" style="width:200px"></td>
	          ...
	          <tr>
	            <td align="right">
				<a href="#"><img src="/img/excel_icon.gif" alt="EXCEL" border="0"></td>
	          </tr>
      ...
      <tr>
        <td><table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="22" background="/img/tab_line_purple.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111" onclick ="subTabClick('divSub2','divSub1')"><a href="#"><img src="/img/sub_periodi_title5_off.gif" alt="기간 연장" width="110" height="22" border="0"></a></td>
