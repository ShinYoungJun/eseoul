		...
		<table width="780" border="0" cellspacing="0" cellpadding="0">
						...
						<table width="780" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td align="center" valign="top"><textarea
									name="CONTENT" class="text_box" style="width:97%;height:300px" readonly>${boardReg.CONTENT}</textarea>
								</td>
							</tr>
						</table>
			...
			<tr>
				...
				<table width="99%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td height="40" align="right"><a href="/admin/noticeBoardList.do"><img align="right" src="/img/go_list.gif" alt="목록으로 가기" border="0" ></a></td>
					</tr>
				</table>
				</td>
			</tr>
