...
<input type="hidden" name="SEQ" value="${SEQ}">
	  ...
	  <tr>
		...
		<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				...
				<tr>
				  <td height="28" align="center" bgcolor="e5eff8" class="sub_table_b">특화거리조성여부</td>
				  <td width="37%" bgcolor="eaeaea" class="table_bl_left">${board.CAR_TON}</td>
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">정비대상여부</td>
				  <td width="36%" bgcolor="eaeaea" class="table_bl_left">${board.MAINTN_OB}</td>
				</tr>
				<tr>
				  <td height="28" align="center" bgcolor="e5eff8" class="sub_table_b">주류판매여부</td>
				  <td width="37%" bgcolor="eaeaea" class="table_bl_left">${board.LIQUOR_SL}</td>
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">LPG사용여부</td>
				  <td width="36%" bgcolor="eaeaea" class="table_bl_left">${board.LPGAS_US}</td>
				</tr>
