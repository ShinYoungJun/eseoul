...
//----------------  ajax start ------------------------------------------------------------//
   ...
   function getBJDong(){
	...
	function jumsearch()
	{
		...
		if(form.ssn2.value != ""){
			ssn = ssn+"-"+form.ssn2.value;
		}

		result.document.getElementById("search").innerHTML = "<img src='/img/mapImg/sing.gif'> 검색중";
		result.result_show.style.display = "none";
		result.location.href="/map/searchresult.do?searchType1="+searchType1+"&type="+type+"&type_name="+type_name+"&gu_cd="+gu_cd+"&bj_cd="+bj_cd+"&bj_nm="+bj_nm+"&spc_cd="+spc_cd+"&bonbun="+bonbun+"&bubun="+bubun+"&jumyongName="+jumyongName+"&ssn="+ssn;		
	}
												...
												<table width="198" border="0" cellpadding="0" cellspacing="0" class="Map_stan">
													<tr>
														...
														<td><select id="searchType1" name="searchType1" class="input_form1" style="width:139px; background:e0eaf7" onchange="javascript:select_searchType();">
																...
																<option value="gapan">보도상 영업시설물</option>															
															</select>
														</td>
													</tr>
													<tr>
...
<script>
//document.getElementById('gu_cd').disabled=true;
</script>
													<tr>
											...
											<td align="center" valign="top" class="M_leftborder2">
												<table width="198" border="0" cellpadding="0" cellspacing="0" class="Map_stan">
													...
													<tr>
														...
														<td><input name="ssn1" type="text" class="input_form1" style="width:60px">
															-
															<input name="ssn2" type="text" class="input_form1" style="width:60px">
														</td>
													</tr>
												</table></td>
										</tr>
