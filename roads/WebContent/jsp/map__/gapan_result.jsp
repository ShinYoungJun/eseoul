										...
										<td>
											<table width="216" border="0" cellpadding="0" cellspacing="0" class="Map_stan">
												...
												<tr>
													...
													<td width="114" align="center" bgcolor="deedf6" class="sub_stan_blue">시설구분</td>
													<td width="1" bgcolor="deedf6"><img src="/img/mapImg/result_blue.gif" width="1" height="20"></td>
													<td width="55" align="center" bgcolor="deedf6" class="sub_stan_blue">관리여부</td>
												</tr>
												<tr>
												...
												<tr>
													<td height="23" align="center">
														<c:if test="${searchlist.XX_COORD != null || searchlist.YY_COORD != null}">
														 <a href="javascript:spop_view('${searchlist.GAPAN_NO}','${searchlist.XX_COORD}','${searchlist.YY_COORD}');" class="inqu"></c:if>
