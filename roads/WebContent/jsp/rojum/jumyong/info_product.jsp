    ...
    <head>
        ...
        <script>
            ...
            function InitPage()
            {
            	...
            	if('${ck_del}' == '1'){
                    location.href = "/rojum/jumyong/rojumCal1.do?GAPAN_NO=${GAPAN_NO}";
                }
            ...
            function goModify()
            {
                ...
                if(area>=0)
                {
                    location.href = "/rojum/jumyong/rojumCal1.do?GAPAN_NO=${GAPAN_NO}&currentPage=${currentPage}&countPerPage=${countPerPage}"
            ...
            function goDelete()        {
                location.href("/rojum/jumyong/rojumCal1.do?GAPAN_NO=${GAPAN_NO}&seq=${seq}&mode=del");
                                    ...
                                    <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                        ...
                                        <c:forEach items="${productList}" var="board" varStatus="idx">
                                            <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''"
                                                onclick="javascript:setParentYear('${board.YEAR}');location.href('/rojum/jumyong/rojumCal1.do?GAPAN_NO=${GAPAN_NO}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}&year=${board.YEAR}&seq=${board.SEQ}&SECTION=${SECTION}');" style="cursor:pointer" >
