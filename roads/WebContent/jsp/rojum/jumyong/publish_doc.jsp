    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function fnRojumCerty()
            {
                ...
                oRptMainParam.put("SERVICE_ITEM" ,form.SERVICE_ITEM.value);
                oRptMainParam.put("PUBLISH_DATE" ,form.PUBLISH_DATE.value);
                oRptMainParam.put("PATH" ,"http://98.33.1.88/filedown/");
                            ...
                            <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                    <tr>
                                        <td width="100" height="26" align="center" bgcolor="e5eff8" class="sub_table_b">관리번호</td>
                                         <td bgcolor="eaeaea" class="table_bl_left"><input name="DOC_NO" type="text" class="input_form1" style="width:160px"  value=""  maxlength="20"></td>
                                        ...
                                        <td width="" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                <tr>
                                                    <td><input name="PUBLISH_DATE" type="text" class="input_form1" style="width:70px" value="" readonly></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><input name="SERVICE_ITEM" type="text" class="input_form1" style="width:300px" value="허가조건 3항" maxlength="40"></td>
                                    </tr>

                                    <tr>
                                        <td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">시설물 가액</td>
                                        <td bgcolor="eaeaea" class="table_bl_left">
                                        <input name="GAPAN_PRICE" type="text" class="input_form1" style="width:120px"  value=""  maxlength="15" onkeyup="calculation_Loan(this)" ></td>
