...
//<![CDATA[
	...
	function Tab_Img_off()
	{
		...
		var img3 	= document.getElementById("minwon_img");
		
		img1.src	= "/img/sub_petition_title2_off.gif";
		img2.src	= "/img/sub_petition_title3_off.gif";
		img3.src    = "/img/sub_petition_title9_off.gif";
	...
	function Tab_Minwon(adminno)
	{
		...
		if(tab.value	== "minwon"	||	tab.value	== "back")
			return;
		else
			tab.value	= "minwon";
				
		var tabs 	= document.getElementById("tab");
		var	img		= document.getElementById("minwon_img");
		
		Tab_Img_off();

		img.src		= "/img/sub_petition_title9_on.gif";
		tabs.src	= "/jumyong/minwon/minwon_view.do?ADMIN_NO=" + adminno;		
	...
	function Tab_Jumin(adminno)
	{
		...
		tabs.src	= "/jumyong/minwon/jumin_view.do?ADMIN_NO=" + adminno;
	}
	...
	function Tab_Jumji(adminno)
	{
		...
		tabs.src	= "/jumyong/jumyong/jumji_view.do?ADMIN_NO=" + adminno;
	}
	...
	//	tab.value	= "back";
		...
		if(val == "8")
			Search();//window.location.replace('/jumyong/minwon/search.do');
	}
      ...
      <tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
                  	<a href="javascript:Tab_Minwon('<%=no%>')">
                  		<img name="minwon_img" src="/img/sub_petition_title9_on.gif" alt="민원 정보" width="110" height="22" border="0"></a></td>
                  <td width="111">
		...
		<td>
		  	<iframe width="100%" height="100%" name="tab" frameborder="0" onload="iFrameResize(this)" scrolling="no" 	src="/jumyong/minwon/minwon_view.do?ADMIN_NO=<%=no%>"></iframe>
		</td>		
		</table>																											
		</td>
	</tr>
