...
<html>
    ...
    <script language='JavaScript' src='/jsp/rojum/jumyong/tab/info_register.js'></script>
    <!--  //********** BEGIN_현진_20120212 -->
      ...
      */
      //********** END_현진_20120212
        ...
        function changeMgTyp(){
        	...
        	var targetTag = getValueSelectTag("MG_TYP");
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
									...
									<tr>
                                        <td width="15%" height="26px" align="center" bgcolor="e5eff8" class="sub_table_b">등록구분</td>
                                        <td colspan="3" bgcolor="f6f6f6" class="table_bl_left">
                                        	<select id="MG_TYP" name="MG_TYP" class="essential" style="width:100px" onchange="changeMgTyp();">
                                            	 ${mg_typ}
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" bgcolor="f6f6f6" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                <tr>
                                                    <td width="90px">${SIDO_NM}시&nbsp;&nbsp;${SIGUNGU}&nbsp;&nbsp;</td>
                                                    <td>
                                     ...
                                     <tr>
										...
										<td colspan="3" bgcolor="f6f6f6" class="table_bl_left">
											...
											<input type="text" id="WITH_DORO_NM" name="WITH_DORO_NM" value="${WITH_DORO_NM}" class="essential" style="width: 250px" onclick="javascript:openZipcodePopup_new('','', 'form.WITH_DORO_NM', '','','','','','','');" maxlength="120"></input>
											<input type="text" id="WITH_BD_BON" name="WITH_BD_BON" value="${WITH_BD_BON}" class="essential" style="width: 25px"></input>
											<input type="text" id="WITH_BD_BU" name="WITH_BD_BU" value="${WITH_BD_BU}" class="essential" style="width: 25px"></input>
										</td>
									</tr>
                                    <tr>
                                        <td width="15%" height="26px" align="center" bgcolor="e5eff8" class="sub_table_b" nowrap>점용지 위치</td>
                                        <td width="35%" bgcolor="f6f6f6" class="table_bl_left" nowrap>
                                            ...
                                            <input id="WITH_ADDR" name="WITH_ADDR" type="text" class="input_form1" style="width:185px"  maxlength="50">
                                        ...
                                        <td width="50%" align="center" bgcolor="e5eff8" class="sub_table_b" rowspan="5" colspan="2" nowrap>
				                            <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="sub_table">
												<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="33%" bgcolor="f6f6f6" class="table_bl_left">
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="f6f6f6" class="table_bl_left">
                                        	<input id="WITH_INFO" name="WITH_INFO" type="text" class="input_form1" style="width:253px" >
                                       	</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td bgcolor="f6f6f6" class="table_bl_left">
                                     		<input id="REG_DATE" name="REG_DATE" type="text" class="input_form1" style="width:120px;"  readonly>
                                    ...
                                    <tr>
                                        ...
                                        <td width="15%" bgcolor="f6f6f6" class="table_bl_left">
                                        	<select id="DP_SEL" name="DP_SEL" class="input_form1" style="width:65px">
                                                ${dp_sel}
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" bgcolor="f6f6f6" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                <tr>
                                                    <td>
                                ...
                                <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                    <tr>
                                        ...
                                        <td width="35%" bgcolor="eaeaea" class="table_bl_left">
                                            ...
                                            <input id="OWNER_IDCHK" name="OWNER_IDCHK" type="checkbox" value="1" onclick="javascript:click_idchk(this);" style="vertical-align: middle;" checked >신분증 확인
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td bgcolor="eaeaea" class="table_bl_left">
                                            ...
                                            <input id="OWNER_CHK" name="OWNER_CHK" type="checkbox" onclick="javascript:Click_OwnerChk(this);"  style="vertical-align: middle;">운영자 미확인                                        
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!-- 
                                     <tr>
                                        ...
                                        <td bgcolor="eaeaea" class="table_bl_left">
                                            <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                <tr>
                                                    <td><input id="OWNER_POST" name="OWNER_POST" type="text" style="width:50px" onFocus="Jumin_toaddr_Check();" onKeyPress="Jumin_toaddr_Check();" onKeyUp="Jumin_toaddr_Check();" onchange="Jumin_toaddr_Check();"  readonly class="input_form1"></td>
                                        ...
                                        <td bgcolor="eaeaea" class="table_bl_left">
                                            <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                <tr>
                                                    <td><input id="OWNER_TOPOST" name="OWNER_TOPOST" type="text" style="width:50px" onFocus="Jumin_toaddr_Check();" onKeyPress="Jumin_toaddr_Check();" onKeyUp="Jumin_toaddr_Check();"  onchange="Jumin_toaddr_Check();"  readonly class="input_form1"></td>
	                                ...
	                                <tr>
										<td width="15%" height="28" align="center" bgcolor="e5eff8" class="sub_table_b" nowrap="nowrap">감면대상</td>
