...
<form name="placeFileForm" id="placeFileForm" method="post" action = "/jumyong/placeFileWrite.do" enctype="multipart/form-data">
                ...
                <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                    ...
                    <tr>
                      ...
                      <spring:bind path="place.DATA_EXPLAIN">
	                      <input name="DATA_EXPLAIN" type="text" class="input_form1" style="width:140px" >
	                  </spring:bind>
	                  </td>
                      <td align="center">
                      <spring:bind path="place.ATTACH_FILE">
    	                  <input name="ATTACH_FILE" id="ATTACH_FILE" type="text" class="input_form1" style="width:140px" >
    	              </spring:bind>
    	              </td>
                      <td align="center">
                      <spring:bind path="place.ATTACH_SIZE">
        	              <input name="ATTACH_SIZE" id="ATTACH_SIZE" type="text" class="input_form1" style="width:45px" >KB
        	          </spring:bind>
        	          </td>
        	          <td align="center"  >
                      <spring:bind path="place.REGDATE">
        	              <input name="REGDATE" id="REGDATE" type="hidden" class="input_form1" style="width:55px" >
        	          </spring:bind>
