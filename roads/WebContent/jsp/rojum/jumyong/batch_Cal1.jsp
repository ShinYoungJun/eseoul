        ...
        <script>
            ...
            function Calculate(){
                ...
                for( var i = 0; i < gapan_no.length; i++){
                    ...
                    {
                        //adjustment[i].value = calJojung(jojung_rate);
            ...
            function submitClick(){
                ...
                f.action = "/rojum/jumyong/batch_cal1_prc.do";
                f.submit();
            }
            ...
            //
            function TaxGubunInfo(){
            	var TAX_GUBUN = getSelectedValue(document.getElementById("TAX_GUBUN"));
            	if(TAX_GUBUN == '3'){
            		alert('신고분은 선택하실수 없습니다.');
            		setSelectedOption(document.getElementById("TAX_GUBUN"),'');
            	}
            }
        	...
        	{
        		var	TAX_SET	=  getSelectedValue(document.getElementById("TAX_SET"));
                                        ...
                                        <tr>
                                            <td  class="contborder_purple">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
															    ...
															    <TD width="754px" valign="top">
															      <DIV id="topLine2" style="width:737px;overflow:hidden;">
															        <TABLE width="1750px" cellpadding="0" cellspacing="0" border="1" class="sub_table" bordercolor="#c9dfed" style="border-collapse:collapse;">
															          <TR>
												                            <td width="100px" height="26px" align="center" bgcolor="e5eff8" class="sub_table_b">운영자명</td>
															      ...
															      <DIV id="leftDisplay2" style="width:110px;height:337px;overflow:hidden;">
															        <TABLE width="100%" cellpadding="0" cellspacing="0" border="1" class="sub_table" bordercolor="#c9dfed" style="border-collapse:collapse;">
											                          ...
											                          <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''">
											                              <td width="110px" height="20px" align="center">
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="2">
                                                            <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                                                <tr>
                                                                    <td colspan="6" height="26px" align="left"  class="sub_table_b">&nbsp;* 산출 내역</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="100px" height="26px" align="center" bgcolor="e5eff8" class="sub_table_b">산출년도</td>
                                                                    <td class="table_bl_left" align="left">
                                                                        <input id="YEAR" name="YEAR" type="text" style="width:90px;ime-mode:disabled;" class="input_form1"  onKeyDown="onlyNumberInput();" value="${YEAR}" maxlength="4" onKeyUp="change_value(this)">
                                                                    </td>
                                                                    <td width="100px" height="26px" align="center" bgcolor="e5eff8" class="sub_table_b">산출기간</td>
                                                                    <td class="table_bl_left" colspan="3" align="left">
                                                                        <input name="FROMDATE" id="FROMDATE" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" value="${FROMDATE}"  onKeyDown="onlyNumberInput();"   onKeyDown="onlyNumberInput();" maxlength=10>
                                                                        	<img src="/img/calendar_icon.gif" onclick="popUpCalendar(this, document.getElementById('FROMDATE'),'yyyymmdd');"  style="cursor:pointer;vertical-align: middle;" >
                                                                        <input name="TODATE" id="TODATE" type="text" class="input_form1" style="width:80px;ime-mode:disabled;"  value="${TODATE}"  onKeyDown="onlyNumberInput();" maxlength=10>
                                                                        	<img src="/img/calendar_icon.gif" onclick="popUpCalendar(this, document.getElementById('TODATE'),'yyyymmdd');"  style="cursor:pointer;vertical-align: middle;" >
                                                                        	&nbsp;&nbsp; 달수 :
                                                                ...
                                                                <tr>
                                                                    <td colspan="6" height="26px" align="left"  class="sub_table_b">&nbsp;* 부과 내역</td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="100px" align="center" bgcolor="e5eff8" class="sub_table_b">과세구분</td>
                                                                    <td bgcolor="eaeaea" class="table_bl_left" align="left">
                                                                        <select name="TAX_GUBUN" id="TAX_GUBUN" class="essential" style="width:100px" onchange="TaxGubunInfo();">
                                                                            ${taxation_part}
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td height="26px" width="100px" align="center" bgcolor="e5eff8" class="sub_table_b">납세자구분</td>
                                                                    <td bgcolor="eaeaea" class="table_bl_left"  align="left">
                                                                ...
                                                                <tr>
                                                                    <td width="100px" align="center" bgcolor="e5eff8" class="sub_table_b">과세일자</td>
                                                                    <td bgcolor="eaeaea" class="table_bl_left" align="left">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <a>
                                                                                        <img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('TAX_DATE'), 'yyyymmdd')" style="CURSOR: pointer;vertical-align: middle;">
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    ...
                                                                    <td bgcolor="eaeaea" class="table_bl_left" colspan="3" align="left">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                	<a>
                                                                                		<img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('INDATE'), 'yyyymmdd')" style="CURSOR: pointer;vertical-align: middle;">
                                                                                	</a>
                                                                               	</td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                	<a>
                                                                                		<img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('OVERDATE'), 'yyyymmdd')" style="CURSOR: pointer;vertical-align: middle;">
                                                                               		</a>
                                                                           		</td>
                                                                            </tr>
                                                                        </table>
                                                    ...
                                                    <tr>
                                                        <td height="40px" align="right" colspan="2">
