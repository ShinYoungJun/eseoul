...
//         		document.getElementById("PERIOD").value = period; 
            ...
            function goModify()
            {
                ...
                { 
                    ...
                    location.href = "/rojum/jumyong/rojumCal2.do?GAPAN_NO=${GAPAN_NO}&currentPage=${currentPage}&countPerPage=${countPerPage}"
                        +"&mode=edit&year="+year+"&seq="+seq+"&SECTION=${SECTION}&RATE=${product.RATE}&REDUCTION_REASON=${product.REDUCTION_REASON}&REDUCTION_RATE=${product.REDUCTION_RATE}&AREA_AFTER=${product.AREA_AFTER}&FORM="+p_form;
            ...
            function Calculate()
            {
               ...
               // var tmp_fromdate = document.getElementById("FROMDATE"); 
                ...
                document.getElementById("FORM").value= area_after+"㎡  X ${product.RATE} X "+price+" X "+adjustment.value+" X "+document.getElementById("PERIOD").value+"/"+perDay+perDayStr+" X "+area_after; 
        	...
        	{ 
        		...
        		document.getElementById("FORM").value= area_after+"㎡  X ${product.RATE} X "+price+" X "+adjustment.value+" X "+document.getElementById("PERIOD").value+"/"+perDay+perDayStr+" X "+area_after;y
        	}
                                    ...
                                    <td>
                                    	...
                                    	<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="eaeaea" class="table_bl_left" > 
                                                <c:forEach items="${productList}" var="board" varStatus="idx"> 
		                                                ${rnic:insertComma2(board.SUM_ADJUST) } 원
		                                        </c:forEach> 
                                                </td>
...
<!-- hoban : 여기까지 -->
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="eaeaea" class="table_bl_left" >
													<!--  //********** BEGIN_현진_20120218 -->
													<!-- 
													<input name="SUM_ADJUST" id="SUM_ADJUST" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" value="${rnic:insertComma2(product.SUM_YEAR)}"> 원
													 -->
													 <input name="SUM_YEAR" id="SUM_YEAR" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" value="${rnic:insertComma2(product.SUM_YEAR)}"> 원
													<!--   //********** END_현진_20120218 -->
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="32%" bgcolor="eaeaea" class="table_bl_left" >
                                                    <!--  //********** BEGIN_현진_20120218 -->
													<!-- 
													<input name="SUM_YEAR" id="SUM_YEAR" type="text" class="input_form1" style="width:80px;ime-mode:disabled;" value=" ${product.SUM_ADJUST}"   onKeyDown="onlyNumberInput();" onkeyup="javascript:fn_addComma(this)" style="text-align:right">원
													-->
