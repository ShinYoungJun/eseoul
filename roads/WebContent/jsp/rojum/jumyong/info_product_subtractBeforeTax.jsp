...
//		insertComma("SUM_ADJUST_VIEW");
	...
	function goModify()
	{
		...
		{
			location.href = "/gapan/jumyong/productSubtractInsert.do?no=${no}&currentPage=${currentPage}&countPerPage=${countPerPage}"
...
//	     alert(sdate+"   "+edate);
	...
	{
		location.href("/gapan/jumyong/productInsert.do?no="+adminNo+"&currentPage="+currentPage+"&mode=add")
//	<a href="/jumyong/productInsert.do?no=${no}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}&mode=add&section=${section}">
	...
	function goSubtract(adminNo,currentPage)
	{
		...
		location.href("/gapan/jumyong/productSubtractInsert.do?no="+adminNo+"&currentPage="+currentPage+"&mode=add&seq="+"${seq}"+"&area="+area);
//	<a href="/jumyong/productInsert.do?no=${no}&year=${board.YEAR}&currentPage=${currentPage}&countPerPage=${countPerPage}&mode=add&section=${section}">
	}
