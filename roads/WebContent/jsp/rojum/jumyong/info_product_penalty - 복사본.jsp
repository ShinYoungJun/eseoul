    ...
    <head>
        ...
        <script>
            ...
            function Calculate()
            {
                ...
                sum_year.value = Math.floor(fixFloatCal(parseFloat(price)*parseFloat((100-parseFloat(reduction_rate))/100)));
                                ...
                                <tr>
                                    <td height="26" align="right" class="sub_table_b">
                                    	<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
							              <tr>
							                <td>
							                	<input name="BEFORE_TAX_YN" type="radio" value="before" onclick="selectBeforeTaxYN('before')">
							                </td>
							                <td width="100px" align="left">사전통지 과태료</td>
							                <td>
							                	<input name="BEFORE_TAX_YN" type="radio" value="original" onclick="selectBeforeTaxYN('original')">
							                </td>
