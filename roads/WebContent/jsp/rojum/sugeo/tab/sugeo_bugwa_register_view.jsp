						...
						<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  			...
				  			<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_nm" type="text" class="essential" style="width:120px" value="${sugeo.owner_nm }">
								</td>
								<td align="center" bgcolor="e5eff8" class="sub_table_b">주민등록번호</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_ssn1" type="text" class="essential" style="width:60px" maxlength="6" value="${sugeo.owner_ssn1 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_ssn1, 6);"> -
									<input name="owner_ssn2" type="text" class="essential" style="width:60px" maxlength="7" value="${sugeo.owner_ssn2 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_ssn2, 7);">
								</td>
						  	</tr>
						  	<tr>
								<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">우편번호</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_zip" type="text" class="essential" style="width:50px" value="${sugeo.owner_zip }" readonly>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_zip_addr1" type="text" class="essential" style="width:120px" value="${sugeo.owner_zip_addr1 }" readonly>
									<input name="owner_zip_addr2" type="text" class="essential" style="width:150px" value="${sugeo.owner_zip_addr2 }">
								</td>
						  	</tr>
						  	...
						  	<tr>
								...
								<td width="37%" bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_tel1" type="text" class="essential" style="width:40px" value="${sugeo.owner_tel1 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_tel1, 3);" maxlength="3">-
									<input name="owner_tel2" type="text" class="essential" style="width:40px" value="${sugeo.owner_tel2 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_tel2, 4);" maxlength="4">-
									<input name="owner_tel3" type="text" class="essential" style="width:40px" value="${sugeo.owner_tel3 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_tel3, 4);" maxlength="4">
								</td>
								<td align="center" bgcolor="e5eff8" class="sub_table_b">휴대전화</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="owner_hp1" type="text" class="essential" style="width:40px" value="${sugeo.owner_hp1 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_hp2, 3);" maxlength="3">-
									<input name="owner_hp2" type="text" class="essential" style="width:40px" value="${sugeo.owner_hp2 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_hp3, 4);" maxlength="4">-
									<input name="owner_hp3" type="text" class="essential" style="width:40px" value="${sugeo.owner_hp3 }" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, owner_hp1, 4);" maxlength="4">
								</td>
						  	</tr>
				  			<tr>
								<td height="30" colspan="4" align="left" bgcolor="#FFFFFF" class="">
							  		<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
										<tr>
									  		<td><span class="sub_stan_blue">&nbsp; * 과태료 부과 : </span>
									  			<input type="checkbox" name="bugwa_yn" value="${sugeo.bugwa_yn }" onclick="javascript:click_idchk(this);"> 과태료 미부과
									  		</td>
										</tr>
								  	</table>
								</td>						
						  	...
						  	<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_area" type="text" class="input_form1" style="width:120px" value="${sugeo.bugwa_area }" onKeyDown="nr_num_float(this);" onKeyUp="nr_num_float(this);" onKeyPress="nr_num_float(this);"> ㎡
								</td>
								<td align="center" bgcolor="e5eff8" class="sub_table_b">기준금액 </td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_danga" type="text" class="input_form1" style="width:120px" value="${sugeo.bugwa_danga }" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this); comma_paste(this);" onKeyPress="nr_num_int(this);"> 원
								</td>
						  	</tr>
							<tr>
								<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">기본 과태료</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_tax" type="text" class="input_form1" style="width:120px" value="${sugeo.bugwa_tax }" maxlength="10" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this); comma_paste(this);" onKeyPress="nr_num_int(this);"> 원
								</td>
								<td align="center" bgcolor="e5eff8" class="sub_table_b">감면율</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_red_rate" type="text" class="input_form1" style="width:120px" value="${sugeo.bugwa_red_rate }" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this);" onKeyPress="nr_num_int(this);" maxlength="3"> % 
							...
							<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_red_tax" type="text" class="input_form1" style="width:120px" value="${sugeo.bugwa_red_tax }" maxlength="10" onKeyDown="nr_num_int(this);" onKeyUp="nr_num_int(this); comma_paste(this);" onKeyPress="nr_num_int(this);"> 원
								</td>
								<td align="center" bgcolor="e5eff8" class="sub_table_b">최종 산출식</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_form" type="text" class="input_form1" style="width:260px" value="${sugeo.bugwa_form }" maxlength="50">
								</td>
							</tr>
							<tr>
								<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">특이사항</td>
								<td colspan="3" bgcolor="eaeaea" class="table_bl_left">
									<input name="bugwa_bigo" type="text" class="input_form1" style="width:500px" maxlength="100" value="${sugeo.bugwa_bigo }" maxlength="50">
								</td>
							</tr>
		                ...
		                <tr>
		                	<c:choose>
			                	<c:when test="${fine_cnt == '0'  }">
			                		<td height="40" align="right"><a href="javascript:goModify_fine('${mul_no }');"><img src="/img/add_icon.gif" alt="추가 " width="56" height="18" border="0"></a>
			                	</c:when>
			                	<c:otherwise>
									<td height="40" align="right"><a href="javascript:goModify_fine('${mul_no }');"><img src="/img/mod_icon.gif" alt="수정 " width="56" height="18" border="0"></a>
								</c:otherwise>
							</c:choose>
						</td>
					</table>
	                ...
	                <tr>
	                  	...
	                  	<table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
							...
							<tr>
								...
								<td width="37%" bgcolor="eaeaea" class="table_bl_left">
									<select name="sale_type" class="essential" style="width:100px">
										${sa_typ }
									</select>
								</td>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									  	<tr>
											<td><input name="sale_date" type="text" class="essential" style="width:120px" value="${sugeo.sale_date }" readonly></td>
						  	...
						  	<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="sale_bigo" type="text" class="essential" style="width:95%" value="${sugeo.sale_bigo}" maxlength="50">
								</td>
								<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">공고번호</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="sale_no" type="text" class="essential" style="width:120px" value="${sugeo.sale_no }" maxlength="20">
								</td>
						  	</tr>
						  	<tr>
							...
							<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<select name="hnd_type" class="essential" style="width:100px">
										${sa_typ }
									</select>
								</td>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									  	<tr>
											<td><input name="hnd_desdate" type="text" class="input_form1" style="width:120px" value="${sugeo.hnd_desdate }" readonly></td>
						  	...
						  	<tr>
								...
								<td bgcolor="eaeaea" class="table_bl_left">
									<input name="hnd_office" type="text" class="input_form1" style="width:180px" value="${sugeo.hnd_office }" maxlength="50">
								</td>
								<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">시행일자</td>
								<td bgcolor="eaeaea" class="table_bl_left">
									<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
									  	<tr>
											<td><input name="hnd_opedate" type="text" class="input_form1" style="width:120px" value="${sugeo.hnd_opedate }" readonly></td>
							...
							<tr>
								...
								<td width="37%" colspan="3" bgcolor="eaeaea" class="table_bl_left" nowrap="nowrap">
									<input name="hnd_bigo" type="text" class="input_form1" style="width:95%" value="" maxlength="${sugeo.hnd_bigo }" maxlength="50">
								</td>
							</tr>
				  	...
				  	<tr>
				  		<c:choose>
							...
							<td height="40" align="right"><a href="javascript:goModify_sale('${mul_no }');"><img src="/img/add_icon.gif" alt="추가 " width="56" height="18" border="0"></a></td>
							</c:when>
							<c:otherwise>
							<td height="40" align="right"><a href="javascript:goModify_sale('${mul_no }');"><img src="/img/mod_icon.gif" alt="수정 " width="56" height="18" border="0"></a></td>
							</c:otherwise>
						</c:choose>
					</tr>
