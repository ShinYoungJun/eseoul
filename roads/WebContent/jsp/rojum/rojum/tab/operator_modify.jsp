		  ...
		  <tr>
			<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				<tr>
				  ...
				  <td  width="35%" bgcolor="eaeaea" class="table_bl_left"><input name="TYPE" type="text" class="input_form1" style="width:130px" value="${use_type}" >
				  <input name="SAN_CK" type="checkbox" value="${board.SAN_CK}" > 신분증 확인
				  </td>
				...
				<tr style="display:block" id="UseType1">
				  ...
				  <td bgcolor="eaeaea" class="table_bl_left">
					<input name="textfield2222722242" type="text" class="input_form1" style="width:80px" value="${board.SAN_CK}" >
					<input name="textfield22227222232" type="text" class="input_form1" style="width:80px" value="${board.SAN_CK}" >
				  </td>
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">생활정보</td>
				  <td bgcolor="eaeaea" class="table_bl_left">
					<select name="select2" class="input_form1" style="width:100px"></select>   
					<input name="textfield2222722242" type="text" class="input_form1" style="width:80px" value="${board.SAN_CK}" >
				  </td>
				</tr>
