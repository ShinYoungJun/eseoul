				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
			              ...
			              <tr>
			                ...
			                <table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
			                  ...
			                  <tr>
			                    <td height="28" align="center" bgcolor="e5eff8" class="sub_table_b">담당부서</td>
			                  ...
			                  <tr>
			                    <td height="28" align="center" bgcolor="e5eff8" class="sub_table_b">전화번호</td>
								...
								<td height="28" align="center" bgcolor="e5eff8" class="sub_table_b" >휴대전화</td>
								<td bgcolor="eaeaea" class="table_bl_left" align="left">
			                  ...
			                  <tr>
			                    <td height="90" align="center" bgcolor="e5eff8" class="sub_table_b">협의내용</td>
			             ...
			             <tr>              
			                <td height="40" align="right">
				                <table border="0" width="100%">
				                	<tr>
				                	<td >
					                	<img src="/img/add_icon.gif" alt="추가" border="0" onclick="javascript:goAdd()" style="cursor:pointer" >					                </td>
