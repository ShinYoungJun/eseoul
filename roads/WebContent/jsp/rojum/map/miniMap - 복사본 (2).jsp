...
var vId = "<%=userId%>";
	...
	function init() {
		...
		if (vId == "cgpark1") {alert("debug 1");}

		if(xc == ''){
			if (vId == "cgpark1") {alert("pnu.len : "+pnu.length);}
			if(pnu.length == 8){
				if (vId == "cgpark1") {alert("debug 2");}
	...
	function wfs_getEqualTo(targetLayer, propertyName, literal, returnFunction) {
		...
		if (vId == "cgpark1") {alert("debug 3");alert("url : \n"+mapServUrl);alert("rtn : \n"+returnFunction);}
