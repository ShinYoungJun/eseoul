										...
										<table border="0" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td><input name="fromDate" type="text"
													class="input_form1" style="width:80px" value=""></td>
...
<tr>page : ${page}, </tr>
<tr>block_page : ${block_page}, </tr>
<tr>searchCause : ${searchCause}, </tr>
<tr>SQL : ${SQL}, </tr>
<tr>confrm_code : ${confrm_code}, </tr>
<tr>sizeOfList : ${sizeOfList}</tr>
