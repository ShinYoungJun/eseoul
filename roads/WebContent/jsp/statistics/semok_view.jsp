							...
							<tr>
								...
								<table width="100%" border="1" bordercolor="#c9dfed"
								    ...
								    <tr>
										...
										<input id="fromDate" name="fromDate" type="text" class="input_form1" style="width:70px" value="${fromDate}"><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('fromDate'), 'yyyymmdd')" style="CURSOR: pointer;vertical-align: middle;"></a>
										~ <input id="toDate" name="toDate" type="text" class="input_form1" style="width:70px" value="${toDate}"><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('toDate'), 'yyyymmdd')" style="CURSOR: pointer;vertical-align: middle;"></a>
								  		</td>
									</tr>					
									...
									<tr>
										...
										<select id="taxCd" name="taxCd" class="related" style="width:300px">
											...
											<c:forEach items="${taxList}" var="taxList">
												<option value="${taxList.TAXCODE}">${taxList.TAXNAME}</option>
											</c:forEach>	
										</select>
										</td>
