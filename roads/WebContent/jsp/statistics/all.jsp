							...
							<tr>
								...
								<table width="100%" border="1" bordercolor="#c9dfed" cellpadding="0" cellspacing="0" class="sub_table" style="border-collapse:collapse;" >
								    <tr>
										...
										<input id="fromDate" name="fromDate" type="text" class="input_form1" style="width:70px" value="${fromDate}"><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('fromDate'), 'yyyymmdd')" style="CURSOR:pointer ;">
										~ <input id="toDate" name="toDate" type="text" class="input_form1" style="width:70px" value="${toDate}"><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('toDate'), 'yyyymmdd')" style="CURSOR:pointer ;">
								  		</td>
									</tr>					
