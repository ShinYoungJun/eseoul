...
//		tabs.src	= "/jumyong/minwon/minwon_view.do?ADMIN_NO=" + adminno;		
		tabs.src	= "/jsp/jumyong/junggi/info_product.jsp?ADMIN_NO=" + adminno;				
  ...
  <tr>
	...
	<!--상단 기안문상신,도움말 메뉴-->		
      ...
      <tr>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tab" frameborder="0" onload="iFrameResize(this)" scrolling="no" 	src="/jumyong/junggi/junggi_product.do?ADMIN_NO=<%=no%>&year=<%=year%>"></iframe>
		</td>		
		</table>																											
		</td>
	</tr>
