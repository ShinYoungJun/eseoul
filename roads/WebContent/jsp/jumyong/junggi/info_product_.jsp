    ...
    <head>
        ...
        <script>
            ...
            function continueProduct()
            {
                ...
                if( rate1 >= 10 && rate1 <=3000 && checkYn == '2' && type == '1')//비율이 허용 범위내에 있을때
                {	
             ...
             // 2015.02.27 kny (점용면적이 다르면 조정계수 적용 대상이 아님
                ...
                if(adjust == 1){
                    ...
                    var SUM_ADJUST = fixFloatCal(parseFloat( removeComma(sum_lastyear))*parseFloat(adjust)*parseFloat(period)/12*(parseFloat(area_after)/parseFloat(old_area)));
