...
<input type="hidden" name="purpose_cd" value="${purpose_search }">
...
<input type="hidden" name="jumyongName" value="${jumyongName }">
  ...
  <tr>
    ...
    <table width="780" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<td>
		  	<iframe width="100%" height="100%" name="tabUp" frameborder="0" onload="iFrameResize(this)" scrolling="no" src="/jumyong/junggi/junggi_view.do?ADMIN_NO=${ADMIN_NO}&message=${message }&year=${year}"></iframe>
		</td>
		<tr>
			<td height="40" align="right">
