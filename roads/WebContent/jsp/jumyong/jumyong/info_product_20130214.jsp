        ...
        <script>
            ...
            function Calculate()
            {
                ...
                var sum_adjust;
               	...
               	if(type == '1'){
               		if( rate1 >= 10 && rate1 <=3000 && check_yn == '2')//비율이 허용 범위내에 있을때
                    {	
                    ...
                    <td class="contborder_purple">							            
                        ...
                        <div id="edit" style="width:100%;display:none;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td width="100" height="26" align="center" bgcolor="e5eff8" class="sub_table_b"  >점용면적</td>
                                    <td bgcolor="eaeaea" class="table_bl_left" ><input id="AREA_AFTER" name="AREA_AFTER" type="text" class="essential" style="width:50px;ime-mode:disabled;" value="${product.AREA_AFTER}"   onfocus="javascript:ShowMsgJumjiInsert(this)" style="text-align:right" readonly="readonly">㎡ / 개</td>                     
                                <td width="100" height="26" align="center" bgcolor="e5eff8" class="sub_table_b">요율/단가</td>
