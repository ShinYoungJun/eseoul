...
//		else san_ck = "0";
		...
		location.href="/jumyong/search.do?tDate="+toDate+"&fDate="+fromDate+"&type="+type+"&section="+section
                ...
                <tr>
                  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                      ...
                      <tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''">
                        ...
                        <td align="center"><a href="/jsp/jumyong/jumyong/info.jsp?no=${board.ADMIN_NO}&section=${board.SECTION}">${board.ADMIN_NO2}</a></td>
