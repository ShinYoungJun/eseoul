...
//<![CDATA[
	...
	function	ModifyPrc()
	{
		parent.parent.iframe2.location.reload();
		...
		form.action = "/jumyong/jumyong/jumji_modify_prc.do";
		form.submit();
	}
	...
	function	Cancel()
	{
		...
		form.action = "/jumyong/minwon/jumji_view.do";
		form.submit();
	}
...
<body onload="Init_UseType('${board.TYPE}'); Init_UseSection('${board.SECTION}'); Init_SANCheck('${board.SAN_CK}'); Init_PurposeCode();">
			...
			<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					<td>
					  <input name="MUL_FROMDATE" type="text" class="input_form1" style="width:70px" value="${board.MUL_FROMDATE}"><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('FROMDATE'), 'yyyymmdd')"></a>
					   ~ <input name="MUL_TODATE" type="text" class="input_form1" style="width:70px" value="${board.MUL_TODATE}"><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('TODATE'), 'yyyymmdd')"></a></tr>
					</td>
			    ...
			    <tr>
				  ...
				  <table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					  <tr>
						<td><input name="WITH_POST" type="text" class="input_form1" style="width:120px" value="${board.WITH_POST}"></td>
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					 <input name="WITH_ADDR1" type="text" class="input_form1" style="width:200px" value="${board.WITH_ADDR1}">
			    ...
			    <tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					  <td><input name="WORK_FROMDATE" type="text" class="input_form1" style="width:70px" value="${board.WORK_FROMDATE}"></td>
					  <td><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('WORK_FROMDATE'), 'yyyymmdd')"></a></td>
					  <td width="16" align="center">~</td>
					  <td><input name="WORK_TODATE" type="text" class="input_form1" style="width:70px" value="${board.WORK_TODATE}"></td>
					  <td><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" onclick="popUpCalendar(this, document.getElementById('WORK_TODATE'), 'yyyymmdd')"></a></td>
					</tr>
				  </table></td>
			    </tr>
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<input name="EXE_INFO" type="text" class="input_form1" style="width:600px" value="${board.EXE_INFO}"></td>
				  </tr>
				  </table></td>
			    </tr> 
