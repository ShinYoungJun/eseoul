...
<form id="form" name="form" method="post" action = "/jumyong/jumyong/minwon.do" >
			...
			<tr>
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  <tr>
					...
					<td width="181" bgcolor="eaeaea" class="table_bl_left"><input name="REQ_NO" type="text" class="input_form1" style="width:120px" value="${appeal.ADMIN_NO}" readonly></td>
