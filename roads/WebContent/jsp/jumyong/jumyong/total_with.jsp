...
<html>
    ...
    <script type="text/javascript">
        ...
        function init(){
            ...
            if(IDX != ""){
            	if(opener.document.getElementsByName("WITH_XML")[IDX].value != ""){
                    document.getElementById("WITH_XML").value = opener.document.getElementsByName("WITH_XML")[IDX].value;
                }               
            }else{
        ...
        function save(){
            ...
            var pBONBUN = document.getElementById("ORG_BONBUN").value;
            var pBUBUN = document.getElementById("ORG_BUBUN").value;
            ...
            if(checkList(pBONBUN,pBUBUN)){
                ...
                if(IDX != ""){
                    opener.document.getElementsByName("WITH_XML")[IDX].value = document.getElementById("WITH_XML").value;
                    opener.totalWithAdd(IDX);               
                }else{
    ...
    <body onload="init()">
        <form name="form" method="post">
            ...
            <input type="hidden" name="ORG_BONBUN" value="${ORG_BONBUN}">
            <input type="hidden" name="ORG_BUBUN" value="${ORG_BUBUN}">
