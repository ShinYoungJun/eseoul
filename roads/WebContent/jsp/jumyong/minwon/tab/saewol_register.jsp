			...
			<div class="tabcontent">
                ...
                <tr>
					...
					<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<input id="min_agent_tel" name="min_agent_tel" type="text" class="input_form1" style="width:100px" value="${min_agent_tel}" onKeyPress="nr_num_int(this);" onKeyUp="nr_num_int(this);" maxlength="11">
						</td>
					</tr>
					<tr>
						...
						<td bgcolor="eaeaea" class="table_bl_left">
							<input id="min_ssn1" name="min_ssn1" type="text" class="input_form1" style="width:40px; ime-mode:disabled" value="${min_ssn1}" onKeyPress="nr_num_int(this);" onKeyUp="count_check(this, min_ssn2, 6);" maxlength="6">
							 - <input id="min_ssn2" name="min_ssn2" type="text" class="input_form1" style="width:87px; ime-mode:disabled" value="${min_ssn2}" onKeyPress="nr_num_int(this);" maxlength="7"></td>
					</tr>
				 	<tr>
                ...
                <tr>
				  	...
				  	<tr>
						...
						<td width="36%" bgcolor="eaeaea" class="table_bl_left">
						  ...
						  - <input id="jumin_ssn2" name="jumin_ssn2" type="text" class="essential" style="width:45px; ime-mode:disabled" value="${jumin_ssn2}" onKeyPress="nr_num_int(this);" maxlength="7"></td>
					</tr>
				  	<tr>
			...
			<div class="tabcontent" style="display:none">
				...
				<tr>
					...
					<tr>
					  	<td height="26px" align="center" bgcolor="e5eff8" class="sub_table_b">우편번호</td>
					  	<td bgcolor="eaeaea" class="table_bl_left">
						  	<input id="MUL_POST" name="MUL_POST" type="text" class="essential" style="width:50px" value="${MUL_POST}" readonly>						  	
							<!--  //********** BEGIN_현진_20120222 -->
							<!-- 
					...
					<tr>
						<td height="26" align="center" bgcolor="e5eff8" class="sub_table_b">점용면적</td>
					  	<td height="26" bgcolor="eaeaea" class="table_bl_left" colspan="3">
							<input id="AREA_SIZE" name="AREA_SIZE" type="text" class="essential" style="width:50px" value="${AREA_SIZE}" style="ime-mode:disabled" onKeyDown="nr_num_float(this);" onKeyUp="nr_num_float(this);" onKeyPress="nr_num_float(this);" maxlength="17"> ㎡ / 개
						</td>
					</tr>
					<tr>
