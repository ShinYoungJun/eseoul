...
<html>
    ...
    <script type="text/javascript">
        ...
        function	makeList()
        {
            ...
            var	top	= "<table width='340' border='1' bordercolor='#c9dfed' style='border-collapse:collapse;' cellpadding='0' cellspacing='0'  class='sub_table'>" +
                ...
                "<td width = '40'  align='center' bgcolor='e5eff8' class='sub_table_b'>삭제</td></tr>";
            ...
            if(length	> 0)
            {
                for(i = 0	;	i < length	;	i++)
                {
                    ...
                    tag	+= "<tr onClick=" + method + " onMouseOver=this.style.backgroundColor='#f6f7f8' onMouseOut=this.style.backgroundColor='' style='CURSOR: Hand;'>" +
                        ...
                        "<td width = '30' align=center><img src='/img/del_icon2.gif' alt='삭제' border='0' onclick='javaScript:Delete(" + (i + 1) + ");' style='CURSOR:Hand;'></td></tr>";
            ...
            var	bottom	="<tr>"
        				 ...
        				 +"</tr>"
                	     +"<tr>"
            			 +"<td align='center' bgcolor='e5eff8' class='sub_table_b' height='26'>갯수</td>"
        ...
        function openLandPricePopUp()
        {
            ...
            var address = "";
            address += document.getElementById("SIDO_CD").value;
            address += document.getElementById("GU_CD").value;
            address += document.getElementById("BJ_CD").value;
            address += document.getElementById("SPC_CD").value;
            ...
            window.open('/jumyong/minwon/officialLandPrice.do?ADDRESS='+address+'&YEAR='+year+'&BONBUN='+bonbun+'&BUBUN='+bubun, 'win', status);
        ...
        function save(){
            ...
            if(checkList(pBONBUN,pBUBUN)){
                alert("대표 점용지 공시지가가 없습니다.");
                document.getElementById("BONBUN").value = pBONBUN;
                document.getElementById("BUBUN").value = pBUBUN;
    ...
    <body onload="init()">
        <form name="form" method="post">
            <input type="hidden" name="SIDO_CD" value="${SIDO_CD}">
            <input type="hidden" name="GU_CD" value="${GU_CD}">
 			<input type="hidden" name="BJ_CD" value="${BJ_CD}">
 			<input type="hidden" name="HJ_CD" value="${BJ_CD}">
            <input type="hidden" name="SPC_CD" value="${SPC_CD}">
            <input type="hidden" name="YEAR" value="${YEAR}">
            <input type="hidden" name="WITH_XML">
                            ...
                            <tr>
                                <td>
                                    <table width="350" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" >
                                        <tr>
                                            <td >
                                            	<table width="340" border='1' bordercolor='#c9dfed' style='border-collapse:collapse;' cellpadding='0' cellspacing='0'  class='sub_table'>
                                                	<tr >
        										        ...
        										        <td width = '176'  align='center' bgcolor='e5eff8' class='sub_table_b'>공시지가</td>
                									</tr>
                									<tr>
                										<td>
                										  <input align="middle" type="text" name="BJ_NM" value="${BJ_NM}"  class="essential" style="width:50px" readonly="readonly">
                                               
                										</td>
                										
                										<td>
                										<input align="middle" type="text" name="BONBUN" value="" class="input_form1" style="width:42px" maxlength="4" onKeyDown="onlyNumberInput();" >
                                               
                										</td>
                										<td>
                										  <input align="middle" type="text" name="BUBUN" value="" class="input_form1" style="width:42px" maxlength="4" onKeyDown="onlyNumberInput();">
                                              
                										</td>
                										<td>
                										 <input align="middle" type="text" name="PRICE" value="" class="input_form1" style="width:80px" onKeyDown="onlyNumberInput();" ><img src="/img/landPrice.gif" alt="공시지가조회" height="18" border="0" style="cursor:pointer" onclick="javascript:openLandPricePopUp();" align="absmiddle">
                                        				</td>
