			...
			<tr>
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left">
						<input name="B_PERMISSION" type="text" class="input_form1" style="width:250px" value="${board.BEFORE_PERMISSION}" style="ime-mode:disabled" onchange="Jumin_toaddr_Check2();" onFocus="Jumin_toaddr_Check2();"  onkeyup="Jumin_toaddr_Check2();" maxlength="20">
					</td>
				  </tr>
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left">
						...
						<input name="TEL1" value="${board.TEL1}" type="text" class="input_form1" style="width:25px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TEL2, 3),Jumin_toaddr_Check2()" maxlength="3"> - 
						<input name="TEL2" value="${board.TEL2}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TEL3, 4),Jumin_toaddr_Check2()" maxlength="4"> - 
						<input name="TEL3" value="${board.TEL3}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, HP1, 4),Jumin_toaddr_Check2()" maxlength="4">
					...
					<td bgcolor="eaeaea" class="table_bl_left">
					   ...
					   <input name="HP1" value="${board.HP1}" type="text" class="input_form1" style="width:25px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, HP2, 3),Jumin_toaddr_Check2()" maxlength="3"> - 
					   <input name="HP2" value="${board.HP2}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, HP3, 4),Jumin_toaddr_Check2()" maxlength="4"> - 
					   <input name="HP3" value="${board.HP3}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="nr_num_int(this),Jumin_toaddr_Check2()" maxlength="4">
				  ...
				  <tr>
					...
					<td bgcolor="eaeaea" class="table_bl_left">
						...
						<input name="TOTEL1" value="${board.TOTEL1}" type="text" class="input_form1" style="width:25px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TOTEL2, 3),Jumin_toaddr_Check2()" maxlength="3"> - 
						<input name="TOTEL2" value="${board.TOTEL2}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TOTEL3, 4),Jumin_toaddr_Check2()" maxlength="4"> - 
						<input name="TOTEL3" value="${board.TOTEL3}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TOHP1, 4),Jumin_toaddr_Check2()" maxlength="4">
					...
					<td bgcolor="eaeaea" class="table_bl_left">
						...
						<input name="TOHP1" value="${board.TOHP1}" type="text" class="input_form1" style="width:25px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TOHP2, 3),Jumin_toaddr_Check2()" maxlength="3"> - 
						<input name="TOHP2" value="${board.TOHP2}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="count_check(this, TOHP3, 4),Jumin_toaddr_Check2()" maxlength="4"> - 
						<input name="TOHP3" value="${board.TOHP3}" type="text" class="input_form1" style="width:30px" style="ime-mode:disabled" onKeyPress="nr_num_int(this),Jumin_toaddr_Check2()" onKeyUp="nr_num_int(this),Jumin_toaddr_Check2()" maxlength="4">
