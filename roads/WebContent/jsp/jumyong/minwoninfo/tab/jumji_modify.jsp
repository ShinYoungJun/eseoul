...
//<![CDATA[
	...
	function	ModifyPrc()
	{
		...
		form.action = "/jumyong/minwoninfo/jumji_modify_prc.do";
		form.submit();
	}
	...
	function	Cancel()
	{
		...
		form.action = "/jumyong/minwoninfo/jumji_view.do";
		form.submit();
	}
			...
			<td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
                ...
                <tr>
                  ...
                  <td bgcolor="eaeaea" class="table_bl_left">
                  	<input name="ROAD_ADDR" type="text" class="input_form1" style="width:140px" value="${board.ROAD_ADDR}" maxlength="12">
                  </td>
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" ><table width="100%" border="0" cellpadding="0" cellspacing="0">
					<iframe id="IFRM_PurposeCode" scrolling="no" frameborder="0" framespacing="0" width="100%" height="25" src="/jsp/common/purposeCode/purposeCode.jsp?SectionCode=${board.TYPE}&PURPOSE_CD=${board.PURPOSE_CD}&essential=1&modify_flag=1"></iframe>
				  </table></td>
			    </tr>			    
				...
				<tr>
				  ...
				  <td colspan="3" bgcolor="eaeaea" class="table_bl_left"><table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
					<tr>
					<td>
					  <input name="MUL_FROMDATE" type="text" class="essential" style="width:70px" value="${board.MUL_FROMDATE}" readonly><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('MUL_FROMDATE'), 'yyyymmdd')" style="CURSOR: Hand;"></a>
					   ~ <input name="MUL_TODATE" type="text" class="essential" style="width:70px" value="${board.MUL_TODATE}" readonly><a><img src="/img/calendar_icon.gif" width="19" height="16" border="0" align="absmiddle" onclick="popUpCalendar(this, document.getElementById('MUL_TODATE'), 'yyyymmdd')" style="CURSOR: Hand;"></a></tr>
					</td>
