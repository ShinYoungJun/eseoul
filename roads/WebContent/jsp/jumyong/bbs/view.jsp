...
<table width="800" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td>
						<table width="760" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0" class="sub_table">
							...
							-->							
							<tr  bgcolor="#eaeaea" onMouseOver="this.style.backgroundColor='#'" onMouseOut="this.style.backgroundColor='#eaeaea'" onclick="javascript:location.href('jumyong_content.action?sid=${dto.sid }');" style="cursor: pointer">
							...
							<c:forEach var="dto" items="${lists}">
								...
								<!-- 	
									...
									<td align="center" class="input_form1"><a href="jumyong_content.action?sid=${dto.sid }" id="title" name="title">${dto.title }</a></td>
								...
								-->
								<!--   //********** END_현진_20120219 -->
								<tr onMouseOver="this.style.backgroundColor='#f6f7f8'" onMouseOut="this.style.backgroundColor=''" onclick="javascript:location.href('jumyong_content.action?sid=${dto.sid }');" style="cursor: pointer">
	...
	<tr>
		<td align="right"><img src="/img/bbs_register.gif" id="register" name="register" alt="글쓰기" width="66" height="22" border="0" onclick="location.href='jumyong_upload_list.action?user_id=<%=user_id%>'" style="cursor:Pointer;"><img src="/img/list_icon.gif" alt="리스트" width="66" height="22" border="0" onclick="location.href='jumyong_list.action'" style="cursor:Pointer;">
		</td>
	</tr>
</table>
