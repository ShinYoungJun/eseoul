      ...
      <tr>
        ...
        <tr>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111"><a href="javascript:Tab_Jumin('${ADMIN_NO}')"><img id="jumin_img" name="jumin_img" src="/img/sub_petition_title2_on_b.gif" alt="점용인 정보" width="110" height="22" border="0"></a></td>
                  <td><a href="javascript:Tab_Jumji('${ADMIN_NO}')"><img id="jumji_img" name="jumji_img" src="/img/sub_petition_title3_off.gif" alt="점용지 정보" width="110" height="22" border="0"></a></td>
                </tr>
            </table>
            </td>
		</tr>
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="22" background="/img/tab_line_blue.gif"><table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="111"><a href="javascript:Tab_Gigan('${ADMIN_NO}')"><img id="bugwa_img" name="bugwa_img" src="/img/sub_periodi_title5_on.gif" alt="기간 연장" width="110" height="22" border="0"></a></td>
