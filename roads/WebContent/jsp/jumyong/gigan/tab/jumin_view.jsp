			  ...
			  <td><table width="100%" border="1" bordercolor="#c9dfed" style="border-collapse:collapse;" cellpadding="0" cellspacing="0"  class="sub_table">
				  ...
				  <td align="center" bgcolor="e5eff8" class="sub_table_b">주소</td>
					...
					<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						...
						<tr><td><c:if test="${board.SAN == '1'}">산&nbsp;</c:if>${board.BON}<c:if test="${board.BU != null}">-${board.BU}</c:if>&nbsp;${board.ADDR2}<td></tr>
					</table>
					</td>
				  ...
				  <tr>
					...
					<table border="0" cellpadding="0" cellspacing="0" class="sub_stan">
						...
						<tr><td><c:if test="${board.TOSAN == '1'}">산&nbsp;</c:if>${board.TOBON}<c:if test="${board.TOBU != null}">-${board.TOBU}</c:if>&nbsp;${board.TOADDR2}<td></tr>
					</table>
					</td>
