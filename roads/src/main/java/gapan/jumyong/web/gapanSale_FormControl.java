...
public class gapanSale_FormControl extends SimpleFormController {	
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		System.out.println("gapanSale_FormControl : : formBackingObject");
		...
		SaleBean pb = null;
			...
			if(userId != null)
			{
				...
				//section 검출
				String strFormView = "/gapan/jumyong/info_product_sale";
				...
				//페이지 성공후 돌아갈 페이지
				setSuccessView("redirect:/gapan/jumyong/gapanSale.do?GAPAN_NO="+gapanNo);
			}
		return pb;
	}	
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception	 {
		...
		System.out.println("gapanSale_FormControl : : onSubmit");
