...
public class MinwoninfoMapDao extends RoadsJdbcDaoSupport
{
    ...
    protected	class	Minwon_View	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Minwon_View"));
    ...
    protected	class	Minwon_View_Search	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Minwon_View_Search"));
    ...
    protected	class	Minwon_Modify	extends	SqlUpdate
    {
        ...
        {
            super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Minwon_Modify"));
    ...
    protected	class	Minwon_Register	extends	SqlUpdate
    {
        ...
        {
            super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Minwon_Register"));
    ...
    protected	class	Jumin_View	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Jumin_View"));
    ...
    protected	class	Jumin_Modify	extends	SqlUpdate 
    {
        ...
        {
            super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Jumin_Modify"));
    ...
    protected	class	Jumji_View	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Jumji_View"));
    ...
    protected	class	Jumji_Modify	extends	SqlUpdate
    {
        ...
        {
            super(ds, msa.getMessage("Querys.jumyong.minwoninfo.Jumji_Modify"));
