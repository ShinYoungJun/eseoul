...
public class GiganDao	extends RoadsJdbcDaoSupport	implements	IGiganDao{
	...
	{
		String sql = getMessageSourceAccessor().getMessage("Querys.facility.gigan.Count");
    ...
    public	List	executeJumin_View(String strCorpCd,String strGuCode)
	{
    	...
    	Object[] values = {strCorpCd, strGuCode};
    ...
    public	List	executeJumji_View(String corpCd,String guCode,String requestNo,String type,String objectNo)
	{
    	...
    	System.out.println(corpCd+"::"+guCode+"::"+requestNo+"::"+type+"::"+objectNo);
    	Object[] values = {corpCd,guCode,requestNo,objectNo};
	...
	{
		String sql = getMessageSourceAccessor().getMessage("Querys.facility.gigan.Gigan_Count");
	...
	{
		String sql = getMessageSourceAccessor().getMessage("Querys.facility.gigan.Gigan_TotalCount");
