...
import main.java.facility.gigan.dao.IGiganDao;
...
public class GiganService	implements	IGiganService{
	...
	public void setFacility_giganDao(IGiganDao facility_giganDao)
	{
	    this.iGiganDao = facility_giganDao;
	}
	...
	{
		return iGiganDao.executeJumin_View(strCorpCd,strGuCode);
	}
	
	public List executeJumji_View(String corpCd,String guCode,String requestNo,String type,String objectNo)
	{
		return iGiganDao.executeJumji_View(corpCd,guCode,requestNo,type,objectNo);
	}
