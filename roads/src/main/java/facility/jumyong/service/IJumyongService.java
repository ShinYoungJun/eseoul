...
//  quantity 
    ...
    public void Equip_CalculationUpdateHan(Equip_ProductBean objProductBean);
    ...
    public int Euip_CalculationCount(String gu_code,String corp_cd,String year, String admin_nos);
