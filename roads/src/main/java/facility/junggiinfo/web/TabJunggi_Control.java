...
public class TabJunggi_Control	extends MultiActionController {
	...
	public ModelAndView		Minwon_View(HttpServletRequest request,HttpServletResponse response) throws Exception 
	{
		...
		try{
			if(userId != null){
				...
				list	= iJunggiinfoService.executeMinwon_View(adminno);
		...
		return new ModelAndView("/facility/junggiinfo/tab/minwon_view","blist", list); 
	}
	...
	public ModelAndView		Minwon_View_Search(HttpServletRequest request,HttpServletResponse response) throws Exception 
	{
		...
		List	list	= iJunggiinfoService.executeMinwon_View_Search(ADMIN_NO, SEQ);
		List	ssn		= null;
	...
	public ModelAndView		Minwon_Modify(HttpServletRequest request,HttpServletResponse response) throws Exception 
	{
		...
		try{
			...
			//	System.out.println("SEQ ; " + SEQ);
				...
				list	= iJunggiinfoService.executeMinwon_View_Search(ADMIN_NO, SEQ);
				List	ssn		= null;
		...
		return new ModelAndView("/facility/junggiinfo/tab/minwon_modify", "board", Bean);
	}
...
//		String 	SEQ 		= ServletRequestUtils.getStringParameter(request, "SEQ", "");
	...
	public ModelAndView		Minwon_Register(HttpServletRequest request,HttpServletResponse response) throws Exception 
	{
		...
		return new ModelAndView("/facility/junggiinfo/tab/minwon_register");
	}
	...
	public void		Minwon_Modify_Execute(HttpServletRequest request,HttpServletResponse response) throws Exception 
	{
		...
		iJunggiinfoService.executeMinwon_Modify(Bean);
	}
	...
	//	userBean	= commonCode.executeUserSearch(util.getSessionID(request, "sessionUserId"));
		...
		iJunggiinfoService.executeMinwon_Register(minwonBean);
