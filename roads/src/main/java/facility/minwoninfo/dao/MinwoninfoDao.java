...
public class MinwoninfoDao	extends RoadsJdbcDaoSupport	implements	IMinwoninfoDao
{
    ...
    public	int		executeMinwon_Count(String strAdmin_no)
    {
    	...
    	String sql = getMessageSourceAccessor().getMessage("Querys.facility.minwoninfo.Minwon_Count");
    ...
    public	boolean	executeJumin_Modify(AppealBean Bean)
	{
		...
		try
		{
			...
			System.out.println("MinwoninfoDay.executeJumin_Modify");
		...
		System.out.println("MinwoninfoMapDao.Jumin_Modify");
		System.out.println("MinwoninfoMapDao.Jumin_Modify");
		System.out.println("MinwoninfoMapDao.Jumin_Modify");
		System.out.println("MinwoninfoMapDao.Jumin_Modify");
		System.out.println("MinwoninfoMapDao.Jumin_Modify");
