...
public class ProductBean extends RoadsBaseBean {
	...
	private String LT_SEL_YN = "";
	
	
	//********** BEGIN_KANG_20120705
	private String BEFORE_SEQ = "";
	private String BEFORE_YEAR = "";
	//********** END_KANG_20120705
	...
	public void setBEFORE_SEQ(String bEFORESEQ) {
		BEFORE_SEQ = bEFORESEQ;
	}
	public String getBEFORE_YEAR() {
		return BEFORE_YEAR;
	}
	public void setBEFORE_YEAR(String bEFOREYEAR) {
		BEFORE_YEAR = bEFOREYEAR;
	}
	public void setLT_SEL_YN(String lT_SEL_YN) {
		LT_SEL_YN = lT_SEL_YN;
	}
	public String getLT_SEL_YN() {
		return LT_SEL_YN;
	}
