...
public class GiganMapDao {
    ...
    protected	class	Search	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Search"));
    ...
    protected	class	Jumin_View	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Jumin_View"));
    ...
    protected	class	Jumji_View	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Jumji_View"));
    ...
    protected	class	Gigan_Search	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Gigan_Search"));
    ...
    protected	class	Gigan_Register	extends	SqlUpdate
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Gigan_Register"));
    ...
    protected	class	Gigan_Ext	extends	SqlUpdate
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Gigan_Ext"));
    ...
    protected	class	Gigan_All_Register	extends	SqlUpdate
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Gigan_All_Register"));
    ...
    protected	class	Gigan_All_Ext	extends	SqlUpdate
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Gigan_All_Ext"));
    ...
    protected	class	Admin_Search	extends	MappingSqlQuery
    {
        ...
        {
          	super(ds, msa.getMessage("Querys.junggi.gigan.Admin_Search"));
