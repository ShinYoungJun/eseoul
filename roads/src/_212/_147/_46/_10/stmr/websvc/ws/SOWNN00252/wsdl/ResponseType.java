...
public class ResponseType  implements java.io.Serializable {
    ...
    private _212._147._46._10.stmr.websvc.ws.SOWNN00252.wsdl.ResponseTypeDATA DATA;
    ...
    public ResponseType(
           ...
           _212._147._46._10.stmr.websvc.ws.SOWNN00252.wsdl.ResponseTypeDATA DATA) {
           this.IFID = IFID;
           this.ORGCD = ORGCD;
     ...
     * @return DATA
     */
    public _212._147._46._10.stmr.websvc.ws.SOWNN00252.wsdl.ResponseTypeDATA getDATA() {
        return DATA;
    }
     ...
     * @param DATA
     */
    public void setDATA(_212._147._46._10.stmr.websvc.ws.SOWNN00252.wsdl.ResponseTypeDATA DATA) {
        this.DATA = DATA;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://10.46.147.212:3100/stmr/websvc/ws/SOWNN00252/wsdl", "ResponseType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://10.46.147.212:3100/stmr/websvc/ws/SOWNN00252/wsdl", ">ResponseType>DATA"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
