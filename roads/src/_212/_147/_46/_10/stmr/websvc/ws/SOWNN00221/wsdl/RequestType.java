...
public class RequestType  implements java.io.Serializable {
    ...
    private _212._147._46._10.stmr.websvc.ws.SOWNN00221.wsdl.RequestTypeDATA DATA;
    ...
    public RequestType(
           ...
           _212._147._46._10.stmr.websvc.ws.SOWNN00221.wsdl.RequestTypeDATA DATA) {
           this.IFID = IFID;
           this.ORGCD = ORGCD;
     ...
     * @return DATA
     */
    public _212._147._46._10.stmr.websvc.ws.SOWNN00221.wsdl.RequestTypeDATA getDATA() {
        return DATA;
    }
     ...
     * @param DATA
     */
    public void setDATA(_212._147._46._10.stmr.websvc.ws.SOWNN00221.wsdl.RequestTypeDATA DATA) {
        this.DATA = DATA;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://10.46.147.212.:3100/stmr/websvc/ws/SOWNN00221/wsdl", "RequestType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://10.46.147.212.:3100/stmr/websvc/ws/SOWNN00221/wsdl", ">RequestType>DATA"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
